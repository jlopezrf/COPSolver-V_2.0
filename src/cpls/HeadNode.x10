...
public class HeadNode extends CPLSNode{
	...
	public def initialize(config:NodeConfig, idPlace:Int, teamPoolConfig:PoolConfig, problemSize:Long){
		super.initialize(config, idPlace, teamPoolConfig, problemSize);
