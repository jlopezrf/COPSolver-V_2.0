...
public class CPLSConfig {
 	...
 	public def setCPLSPoolConfig(cplsPoolConfig:PoolConfig){
 		this.cplsPoolConfig = cplsPoolConfig;
 	}
 	
 	public def setTeamsPoolConfig(teamsPoolConfig:PoolConfig){
 		this.teamsPoolConfig = teamsPoolConfig;
 	}
 	...
 	public def getCPLSPoolConfig(){
 		return this.cplsPoolConfig;
 	}
 	
 	public def getTeamsPoolConfig(){
 		return this.teamsPoolConfig;
 	}
 	...
 	public def setASParameters(asParam:ASParameters){
 		this.asParam = asParam;
 	}
 	
 	public def getASParameters(){
 		return this.asParam;
 	}
 	
 	public def setEOParameters(eoParam:EOParameters){
 		this.eoParam = eoParam;
 	}
 	
 	public def getEOParameters(){
 		return this.eoParam;
 	}
 	
 	public def setRoTSParameters(roTSParam:RoTSParameters){
 		this.roTSParam = roTSParam;
 	}
 	
 	public def getRoTSParameters(){
 		return this.roTSParam;
 	}
