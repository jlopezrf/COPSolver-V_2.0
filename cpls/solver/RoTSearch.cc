...
void cpls::solver::RoTSearch::configHeuristic(x10_long problemSize, ::cpls::ParamManager* opts) {
    ...
    this->FMGL(tabuDurationFactorUS) = ::x10aux::nullCheck(opts)->cpls::ParamManager::__apply(
                                         (__extension__ ({ static ::x10::lang::String* strLit__33954 = ::x10aux::makeStringLit("--RoTS_tabu_duration"); strLit__33954; })),
                                         (-(1.0)));
    ...
    this->FMGL(aspirationFactorUS) = ::x10aux::nullCheck(opts)->cpls::ParamManager::__apply(
                                       (__extension__ ({ static ::x10::lang::String* strLit__33955 = ::x10aux::makeStringLit("--RoTS_aspiration"); strLit__33955; })),
                                       (-(1.0)));
}
...
x10_long cpls::solver::RoTSearch::search(::cpls::problem::ProblemGenericModel* problemModel,
            ...
            //#line 100 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/solver/RoTSearch.x10"
            {
                for (j = ((i) + (((x10_long)1ll))); ((j) < (this->::cpls::solver::SingleSolHeuristic::FMGL(problemSize)));
                    ...
                    this->FMGL(autorized) = (((::x10aux::nullCheck(this->FMGL(tabuList))->x10::array::Array_2<x10_long>::__apply(
                                                 i, ((x10_long)(::x10aux::nullCheck(problemModel)->FMGL(variables)->x10::lang::Rail< x10_int >::__apply(
                                                                  j))))) < (((x10_long)(nIter)))) ||
                    ((::x10aux::nullCheck(this->FMGL(tabuList))->x10::array::Array_2<x10_long>::__apply(
                        j, ((x10_long)(::x10aux::nullCheck(problemModel)->FMGL(variables)->x10::lang::Rail< x10_int >::__apply(
                                         i))))) < (((x10_long)(nIter)))));
                                 ...
                                 (x10_long)0x7fffffffffffffffLL)))
    {
        ...
        ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
          reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__33972 = ::x10aux::makeStringLit("All moves are tabu!"); strLit__33972; }))));
        ...
        ::x10aux::nullCheck(this->FMGL(tabuList))->x10::array::Array_2<x10_long>::__set(
          this->FMGL(move)->getFirst(), ((x10_long)(::x10aux::nullCheck(problemModel)->FMGL(variables)->x10::lang::Rail< x10_int >::__apply(
                                                      this->FMGL(move)->getSecond()))),
          ((x10_long)(((nIter) + (t1)))));
        
        //#line 165 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/solver/RoTSearch.x10"
        ::x10aux::nullCheck(this->FMGL(tabuList))->x10::array::Array_2<x10_long>::__set(
          this->FMGL(move)->getSecond(), ((x10_long)(::x10aux::nullCheck(problemModel)->FMGL(variables)->x10::lang::Rail< x10_int >::__apply(
        ...
        if (((v) < (currentCost))) {
            ...
            ::x10::io::Console::FMGL(OUT__get)()->print(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__33979 = ::x10aux::makeStringLit("Costo (RoTSearch): "); strLit__33979; })), v));
            
            //#line 174 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/solver/RoTSearch.x10"
            ::cpls::util::Utils::show((__extension__ ({ static ::x10::lang::String* strLit__33980 = ::x10aux::makeStringLit(". Con variables: "); strLit__33980; })),
...
//#line 239 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/solver/RoTSearch.x10"
