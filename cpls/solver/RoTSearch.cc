...
void cpls::solver::RoTSearch::configHeuristic(::cpls::problem::ProblemGenericModel* problemModel,
    ...
    this->FMGL(tabuDurationFactorUS) = ::x10aux::nullCheck(opts)->cpls::ParamManager::__apply(
                                         (__extension__ ({ static ::x10::lang::String* strLit__43478 = ::x10aux::makeStringLit("-RoTS_t"); strLit__43478; })),
                                         (-(1.0)));
    ...
    this->FMGL(aspirationFactorUS) = ::x10aux::nullCheck(opts)->cpls::ParamManager::__apply(
                                       (__extension__ ({ static ::x10::lang::String* strLit__43479 = ::x10aux::makeStringLit("-RoTS_a"); strLit__43479; })),
                                       (-(1.0)));
}
...
x10_long cpls::solver::RoTSearch::search(x10_long currentCost,
                                 ...
                                 (x10_long)0x7fffffffffffffffLL)))
    {
        ...
        ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
          reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__43495 = ::x10aux::makeStringLit("All moves are tabu!"); strLit__43495; }))));
        ...
        ::x10aux::nullCheck(this->::cpls::solver::SingleSolHeuristic::FMGL(problemModel))->executedSwap(
          ...
          (__extension__ ({
              ::x10::lang::Rail< x10_int >* t__41724 = this->::cpls::solver::SingleSolHeuristic::FMGL(variables);
              if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__41724)->FMGL(size)),
                                             ::x10aux::nullCheck(this)->FMGL(sz)))))
              {
                  ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__43499 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{self.size==this(:cpls.solver.RoTSearch).sz}"); strLit__43499; })))));
              }
              t__41724;
          }))
          );
