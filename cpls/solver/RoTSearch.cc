...
void cpls::solver::RoTSearch::configHeuristic(::cpls::problem::ProblemGenericModel* problemModel,
    ...
    this->FMGL(tabuDurationFactorUS) = ::x10aux::nullCheck(opts)->cpls::ParamManager::__apply(
                                         (__extension__ ({ static ::x10::lang::String* strLit__34354 = ::x10aux::makeStringLit("--RoTS_tabu_duration"); strLit__34354; })),
                                         (-(1.0)));
    ...
    this->FMGL(aspirationFactorUS) = ::x10aux::nullCheck(opts)->cpls::ParamManager::__apply(
                                       (__extension__ ({ static ::x10::lang::String* strLit__34355 = ::x10aux::makeStringLit("--RoTS_aspiration"); strLit__34355; })),
                                       (-(1.0)));
}
...
x10_long cpls::solver::RoTSearch::search(::cpls::problem::ProblemGenericModel* problemModel,
                                 ...
                                 (x10_long)0x7fffffffffffffffLL)))
    {
        ...
        ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
          reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__34368 = ::x10aux::makeStringLit("All moves are tabu!"); strLit__34368; }))));
        ...
        ::cpls::problem::ProblemGenericModel* t__32517 = this->::cpls::solver::SingleSolHeuristic::FMGL(problemModel);
        x10_long i__32518 = this->FMGL(move)->getFirst();
        x10_long i__32519 = this->FMGL(move)->getSecond();
        ::x10::lang::Rail< x10_int >* variables__32520 = (__extension__ ({
            ::x10::lang::Rail< x10_int >* t__32521 = this->::cpls::solver::SingleSolHeuristic::FMGL(variables);
            if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__32521)->FMGL(size)),
                                           ::x10aux::nullCheck(this)->FMGL(sz)))))
            {
                ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__34369 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{self.size==this(:cpls.solver.RoTSearch).sz}"); strLit__34369; })))));
            }
            t__32521;
        }))
        ;
        if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(variables__32520)->FMGL(size)),
                                       ::x10aux::nullCheck(t__32517)->FMGL(size)))))
        {
            ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__34370 = ::x10aux::makeStringLit("!(variables$32350.size == t$32347.size)"); strLit__34370; })))));
        }
        ::x10aux::nullCheck(t__32517)->executedSwap(i__32518,
                                                    i__32519,
                                                    variables__32520);
