...
void cpls::solver::GAIndividual::_constructor(x10_long individualSize, x10_long seed) {
    ...
    ::x10aux::nullCheck(this__4232)->FMGL(randomGenerator) = (::x10aux::class_cast_unchecked< ::x10::util::Random*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    ...
    ::x10aux::nullCheck(this__4233)->x10::util::Random::init(seed__4234);
}
...
void cpls::solver::GAIndividual::_constructor(::cpls::solver::GAIndividual* indiv,
    ...
    //#line 7 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/solver/GAIndividual.x10"
    ::cpls::solver::GAIndividual* this__4238 = this;
    ::x10aux::nullCheck(this__4238)->FMGL(genes) = (::x10aux::class_cast_unchecked< ::x10::lang::Rail< x10_int >*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    ::x10aux::nullCheck(this__4238)->FMGL(cost) = ((x10_long)0ll);
    ::x10aux::nullCheck(this__4238)->FMGL(randomGenerator) =
      (::x10aux::class_cast_unchecked< ::x10::util::Random*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    ...
    ::x10::util::Random* this__4239 = this->FMGL(randomGenerator);
    
    //#line 40 "/home/jason/Documents/Maestria/Implementacion/X10/2-4-2/Building_for_source/x10-2.4.2-src/x10.dist/stdlib/x10.jar:x10/util/Random.x10"
    x10_long seed__4240 = seed;
    
    //#line 41 "/home/jason/Documents/Maestria/Implementacion/X10/2-4-2/Building_for_source/x10-2.4.2-src/x10.dist/stdlib/x10.jar:x10/util/Random.x10"
    ::x10aux::nullCheck(this__4239)->x10::util::Random::init(
      seed__4240);
...
void cpls::solver::GAIndividual::applyLS(::cpls::solver::HeuristicSolver* heuristicSolverAux) {
    ...
    ::cpls::solver::HeuristicSolver* t__4241 = heuristicSolverAux;
    ::x10::lang::Rail< x10_int >* variables__4242 = this->FMGL(genes);
    if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(variables__4242)->FMGL(size)),
                                   ::x10aux::nullCheck(t__4241)->FMGL(sz)))))
    {
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__4245 = ::x10aux::makeStringLit("!(variables$1829.size == t$1828.sz)"); strLit__4245; })))));
    }
    ::x10aux::nullCheck(t__4241)->setVariables(variables__4242);
