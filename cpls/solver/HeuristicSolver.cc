...
class cpls_solver_HeuristicSolver__closure__1 : public ::x10::lang::Closure {
    ...
    const char* toNativeString() {
        return "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/solver/HeuristicSolver.x10:29";
    }
...
x10_long cpls::solver::HeuristicSolver::search(x10_long currentCost,
    ...
    //#line 45 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/solver/HeuristicSolver.x10"
    ::x10aux::nullCheck(this->FMGL(problemModel))->executedSwap(
      sz, this->FMGL(move)->getFirst(), this->FMGL(move)->getSecond(),
      (__extension__ ({
          ::x10::lang::Rail< x10_int >* t__41482 = this->FMGL(variables);
          if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__41482)->FMGL(size)),
                                         sz)))) {
              ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__43463 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{self.size==sz}"); strLit__43463; })))));
          }
          t__41482;
      }))
      );
    ...
    x10_long costo = ::x10aux::nullCheck(this->FMGL(problemModel))->costOfSolution(
                       sz, true, (__extension__ ({
                           ::x10::lang::Rail< x10_int >* t__41484 =
                             this->FMGL(variables);
                           if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__41484)->FMGL(size)),
                                                          sz))))
                           {
                               ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__43464 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{self.size==sz}"); strLit__43464; })))));
                           }
                           t__41484;
                       }))
                       );
...
void cpls::solver::HeuristicSolver::initVar() {
    ...
    //#line 59 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/solver/HeuristicSolver.x10"
...
void cpls::solver::HeuristicSolver::setVariables(x10_long sze,
    ...
    this->FMGL(variables) = (__extension__ ({
        ::x10::lang::Rail< x10_int >* t__41492 = variables;
        if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__41492)->FMGL(size)),
                                       ::x10aux::nullCheck(this)->FMGL(sz)))))
        {
            ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__43465 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{self.size==this(:cpls.solver.HeuristicSolver).sz}"); strLit__43465; })))));
        }
        t__41492;
    }))
    ;
...
x10_boolean cpls::solver::HeuristicSolver::tryInsertIndividual(
  ::x10::lang::Rail< x10_int >* varables, x10_long sze) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__43468 = ::x10aux::makeStringLit("BadInvocation of tryInsertIndividual, this its not a GA Heuristic"); strLit__43468; }))));
    
    //#line 103 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/solver/HeuristicSolver.x10"
    return false;
...
x10_long cpls::solver::HeuristicSolver::getWorstCost() {
    ...
    //#line 107 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/solver/HeuristicSolver.x10"
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__43469 = ::x10aux::makeStringLit("BadInvocation of getWorstCost, this its not a GA Heuristic"); strLit__43469; }))));
...
::x10::lang::Rail< x10_int >* cpls::solver::HeuristicSolver::getConfigForPop(
  x10_boolean replace) {
    ...
    //#line 113 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/solver/HeuristicSolver.x10"
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__43470 = ::x10aux::makeStringLit("BadInvocation of getConfigForPop, this is not a GA Heuristic"); strLit__43470; }))));
...
void cpls::solver::HeuristicSolver::displayInfo(::x10::lang::String* string) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__43471 = ::x10aux::makeStringLit("Error. displayInfo() invokation in HeuristicSolver"); strLit__43471; }))));
}
...
x10_long cpls::solver::HeuristicSolver::reset(x10_long n,
    ...
    //#line 136 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/solver/HeuristicSolver.x10"
...
void cpls::solver::HeuristicSolver::initVariables() {
    ...
    this->FMGL(variables) = (__extension__ ({
        ::x10::lang::Rail< x10_int >* t__41501 = ::x10aux::nullCheck(this->FMGL(problemModel))->initialize(
                                                   ::x10aux::nullCheck(this->FMGL(random))->nextLong());
        if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__41501)->FMGL(size)),
                                       ::x10aux::nullCheck(this)->FMGL(sz)))))
        {
            ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__43472 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{self.size==this(:cpls.solver.HeuristicSolver).sz}"); strLit__43472; })))));
        }
        t__41501;
    }))
    ;
...
//#line 147 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/solver/HeuristicSolver.x10"
void cpls::solver::HeuristicSolver::clearProblemModel() {
    
    //#line 148 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/solver/HeuristicSolver.x10"
...
::x10::lang::Rail< x10_int >* cpls::solver::HeuristicSolver::createNewConf(
    ...
    ::x10::lang::Rail< x10_int >* t__41513 = ::x10aux::nullCheck(this->FMGL(problemModel))->initialize(
                                               ::x10aux::nullCheck(this->FMGL(random))->nextLong());
    if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__41513)->FMGL(size)),
                                   ::x10aux::nullCheck(this)->FMGL(sz)))))
    {
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__43473 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{self.size==this(:cpls.solver.HeuristicSolver).sz}"); strLit__43473; })))));
    }
    return t__41513;
...
x10_double cpls::solver::HeuristicSolver::getDistance(::x10::lang::Rail< x10_int >* a,
    ...
    return ::x10aux::nullCheck(this->FMGL(problemModel))->distance(
             this->FMGL(sz), (__extension__ ({
                 ::x10::lang::Rail< x10_int >* t__41505 =
                   a;
                 if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(a)->FMGL(size)),
                                                ::x10aux::nullCheck(this)->FMGL(sz)))))
                 {
                     ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__43474 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{a.size==this(:cpls.solver.HeuristicSolver).sz}"); strLit__43474; })))));
                 }
                 t__41505;
             }))
             , (__extension__ ({
                 ::x10::lang::Rail< x10_int >* t__41507 =
                   b;
                 if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(b)->FMGL(size)),
                                                ::x10aux::nullCheck(this)->FMGL(sz)))))
                 {
                     ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__43475 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{b.size==this(:cpls.solver.HeuristicSolver).sz}"); strLit__43475; })))));
                 }
                 t__41507;
             }))
             );
...
x10_boolean cpls::solver::HeuristicSolver::verify(::x10::lang::Rail< x10_int >* conf) {
    ...
    return ::x10aux::nullCheck(this->FMGL(problemModel))->verify(
             this->FMGL(sz), (__extension__ ({
                 ::x10::lang::Rail< x10_int >* t__41509 =
                   conf;
                 if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__41509)->FMGL(size)),
                                                ::x10aux::nullCheck(this)->FMGL(sz)))))
                 {
                     ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__43476 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{self.size==this(:cpls.solver.HeuristicSolver).sz}"); strLit__43476; })))));
                 }
                 t__41509;
             }))
             );
...
void cpls::solver::HeuristicSolver::displaySolution(::x10::lang::Rail< x10_int >* conf) {
    ...
    //#line 188 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/solver/HeuristicSolver.x10"
    ::x10aux::nullCheck(this->FMGL(problemModel))->displaySolution(
      sz, (__extension__ ({
          ::x10::lang::Rail< x10_int >* t__41511 = conf;
          if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__41511)->FMGL(size)),
                                         sz)))) {
              ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__43477 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{self.size==sz}"); strLit__43477; })))));
          }
          t__41511;
      }))
      );
