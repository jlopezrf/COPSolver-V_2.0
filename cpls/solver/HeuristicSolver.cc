...
x10_long cpls::solver::HeuristicSolver::search(x10_long currentCost,
    ...
    ::x10aux::nullCheck(this->FMGL(problemModel))->executedSwap(
      ...
      (__extension__ ({
          ::x10::lang::Rail< x10_int >* t__41221 = this->FMGL(variables);
          if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__41221)->FMGL(size)),
                                         sz)))) {
              ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__43219 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{self.size==sz}"); strLit__43219; })))));
          }
          t__41221;
      }))
      );
    ...
    x10_long costo = ::x10aux::nullCheck(this->FMGL(problemModel))->costOfSolution(
                       sz, true, (__extension__ ({
                           ::x10::lang::Rail< x10_int >* t__41223 =
                             this->FMGL(variables);
                           if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__41223)->FMGL(size)),
                                                          sz))))
                           {
                               ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__43220 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{self.size==sz}"); strLit__43220; })))));
                           }
                           t__41223;
                       }))
                       );
...
void cpls::solver::HeuristicSolver::setSolverType(x10_int mySolverType) {
    ...
    //#line 75 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/solver/HeuristicSolver.x10"
...
x10_boolean cpls::solver::HeuristicSolver::tryInsertIndividual(
  ::x10::lang::Rail< x10_int >* varables, x10_long sze) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__43223 = ::x10aux::makeStringLit("BadInvocation of tryInsertIndividual, this its not a GA Heuristic"); strLit__43223; }))));
...
::x10::lang::Rail< x10_int >* cpls::solver::HeuristicSolver::getConfigForPop(
  x10_boolean replace) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__43224 = ::x10aux::makeStringLit("BadInvocation of getConfigForPop, this is not a GA Heuristic"); strLit__43224; }))));
...
void cpls::solver::HeuristicSolver::displayInfo(::x10::lang::String* string) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__43225 = ::x10aux::makeStringLit("Error. displayInfo() invokation in HeuristicSolver"); strLit__43225; }))));
}
...
x10_long cpls::solver::HeuristicSolver::reset(x10_long n,
                                     ...
                                     , ((x10_long)0ll))))
    {
        ...
        //#line 119 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/solver/HeuristicSolver.x10"
...
void cpls::solver::HeuristicSolver::initVariables() {
    ...
    this->FMGL(variables) = (__extension__ ({
        ::x10::lang::Rail< x10_int >* t__41238 = ::x10aux::nullCheck(this->FMGL(problemModel))->initialize(
                                                   ::x10aux::nullCheck(this->FMGL(random))->nextLong());
        if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__41238)->FMGL(size)),
                                       ::x10aux::nullCheck(this)->FMGL(sz)))))
        {
            ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__43226 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{self.size==this(:cpls.solver.HeuristicSolver).sz}"); strLit__43226; })))));
        }
        t__41238;
    }))
    ;
...
::x10::lang::Rail< x10_int >* cpls::solver::HeuristicSolver::createNewSol(
    ...
    //#line 142 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/solver/HeuristicSolver.x10"
    return conf;
...
::x10::lang::Rail< x10_int >* cpls::solver::HeuristicSolver::createNewConf(
    ...
    ::x10::lang::Rail< x10_int >* t__41250 = ::x10aux::nullCheck(this->FMGL(problemModel))->initialize(
                                               ::x10aux::nullCheck(this->FMGL(random))->nextLong());
    if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__41250)->FMGL(size)),
                                   ::x10aux::nullCheck(this)->FMGL(sz)))))
    {
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__43227 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{self.size==this(:cpls.solver.HeuristicSolver).sz}"); strLit__43227; })))));
    }
    return t__41250;
...
//#line 158 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/solver/HeuristicSolver.x10"
...
x10_double cpls::solver::HeuristicSolver::getDistance(::x10::lang::Rail< x10_int >* a,
    ...
    //#line 164 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/solver/HeuristicSolver.x10"
    return ::x10aux::nullCheck(this->FMGL(problemModel))->distance(
             this->FMGL(sz), (__extension__ ({
                 ::x10::lang::Rail< x10_int >* t__41242 =
                   a;
                 if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(a)->FMGL(size)),
                                                ::x10aux::nullCheck(this)->FMGL(sz)))))
                 {
                     ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__43228 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{a.size==this(:cpls.solver.HeuristicSolver).sz}"); strLit__43228; })))));
                 }
                 t__41242;
             }))
             , (__extension__ ({
                 ::x10::lang::Rail< x10_int >* t__41244 =
                   b;
                 if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(b)->FMGL(size)),
                                                ::x10aux::nullCheck(this)->FMGL(sz)))))
                 {
                     ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__43229 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{b.size==this(:cpls.solver.HeuristicSolver).sz}"); strLit__43229; })))));
                 }
                 t__41244;
             }))
             );
...
x10_boolean cpls::solver::HeuristicSolver::verify(::x10::lang::Rail< x10_int >* conf) {
    ...
    return ::x10aux::nullCheck(this->FMGL(problemModel))->verify(
             this->FMGL(sz), (__extension__ ({
                 ::x10::lang::Rail< x10_int >* t__41246 =
                   conf;
                 if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__41246)->FMGL(size)),
                                                ::x10aux::nullCheck(this)->FMGL(sz)))))
                 {
                     ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__43230 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{self.size==this(:cpls.solver.HeuristicSolver).sz}"); strLit__43230; })))));
                 }
                 t__41246;
             }))
             );
...
void cpls::solver::HeuristicSolver::displaySolution(::x10::lang::Rail< x10_int >* conf) {
    ...
    ::x10aux::nullCheck(this->FMGL(problemModel))->displaySolution(
      sz, (__extension__ ({
          ::x10::lang::Rail< x10_int >* t__41248 = conf;
          if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__41248)->FMGL(size)),
                                         sz)))) {
              ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__43231 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{self.size==sz}"); strLit__43231; })))));
          }
          t__41248;
      }))
      );
