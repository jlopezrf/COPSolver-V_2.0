...
void cpls::solver::AdaptiveSearch::configHeuristic(::cpls::problem::ProblemGenericModel* problemModel,
    ...
    this->FMGL(nVarToReset) = ::x10aux::nullCheck(opts)->cpls::ParamManager::__apply(
                                (__extension__ ({ static ::x10::lang::String* strLit__10543 = ::x10aux::makeStringLit("--AS_varToReset"); strLit__10543; })),
                                ((x10_long)-1ll));
    ...
    this->FMGL(resetPercent) = ::x10aux::nullCheck(opts)->cpls::ParamManager::__apply(
                                 (__extension__ ({ static ::x10::lang::String* strLit__10544 = ::x10aux::makeStringLit("--AS_resetPer"); strLit__10544; })),
                                 ((x10_int)10));
    ...
    this->FMGL(freezeLocMin) = ::x10aux::nullCheck(opts)->cpls::ParamManager::__apply(
                                 (__extension__ ({ static ::x10::lang::String* strLit__10545 = ::x10aux::makeStringLit("--AS_freezeLocMin"); strLit__10545; })),
                                 ((x10_int)5));
    ...
    this->FMGL(freezeSwap) = ::x10aux::nullCheck(opts)->cpls::ParamManager::__apply(
                               (__extension__ ({ static ::x10::lang::String* strLit__10546 = ::x10aux::makeStringLit("--AS_freezeSwap"); strLit__10546; })),
                               ((x10_int)5));
    ...
    this->FMGL(resetLimit) = ::x10aux::nullCheck(opts)->cpls::ParamManager::__apply(
                               (__extension__ ({ static ::x10::lang::String* strLit__10547 = ::x10aux::makeStringLit("--AS_resetLimit"); strLit__10547; })),
                               ((x10_int)5));
    ...
    this->FMGL(probSelectLocMin) = ::x10aux::nullCheck(opts)->cpls::ParamManager::__apply(
                                     (__extension__ ({ static ::x10::lang::String* strLit__10548 = ::x10aux::makeStringLit("--AS_probSelecLocMin"); strLit__10548; })),
                                     ((x10_int)0));
    ...
    this->FMGL(firstBest) = (::x10aux::struct_equals(::x10aux::nullCheck(opts)->cpls::ParamManager::__apply(
                                                       (__extension__ ({ static ::x10::lang::String* strLit__10549 = ::x10aux::makeStringLit("--AS_firstBest"); strLit__10549; })),
                                                       ((x10_int)0)),
                                                     ((x10_int)1)));
    ...
    this->FMGL(exhaustive) = (::x10aux::struct_equals(::x10aux::nullCheck(opts)->cpls::ParamManager::__apply(
                                                        (__extension__ ({ static ::x10::lang::String* strLit__10550 = ::x10aux::makeStringLit("--AS_exhaustive"); strLit__10550; })),
                                                        ((x10_int)0)),
                                                      ((x10_int)1)));
}
...
x10_long cpls::solver::AdaptiveSearch::search(x10_long currentCost,
                                 ...
                                 this->FMGL(move)->getSecond())))
    {
        ...
        if (((((((x10_long)(this->FMGL(nVarMarked)))) + (((x10_long)1ll)))) >= (((x10_long)(this->FMGL(resetLimit))))))
        {
            ...
            ::cpls::solver::AdaptiveSearch* this__10540 =
              this;
            ...
            if (((x) <= (nCost))) {
                ...
                ::x10aux::nullCheck(this->FMGL(listIJ))->x10::lang::Rail< ::cpls::util::MovePermutation* >::__set(
                  ((x10_long)(this->FMGL(nListIJ))), (__extension__ ({
                      ::cpls::util::MovePermutation* alloc__1248 =
