            ...
            if (((x) <= (nCost))) {
                ...
                ::x10aux::nullCheck(this->FMGL(listIJ))->x10::lang::Rail< ::cpls::util::MovePermutation* >::__set(
                  ((x10_long)(this->FMGL(nListIJ))), (__extension__ ({
                      ::cpls::util::MovePermutation* alloc__1251 =
