...
//#line 21 "/home/artica/Documents/Maestria/Implementacion/codigo/COPSolver-V_2.0/src/cpls/HeuristicFactory.x10"
::x10::lang::String* cpls::HeuristicFactory::getHeuristicName(x10_int kind) {
    
    //#line 22 "/home/artica/Documents/Maestria/Implementacion/codigo/COPSolver-V_2.0/src/cpls/HeuristicFactory.x10"
    switch (kind) {
        
        //#line 23 "/home/artica/Documents/Maestria/Implementacion/codigo/COPSolver-V_2.0/src/cpls/HeuristicFactory.x10"
        case 2/*::cpls::CPLSOptionsEnum__HeuristicsSupported::FMGL(AS_SOL__get)()*/: ;
        {
            return (__extension__ ({ static ::x10::lang::String* strLit__28169 = ::x10aux::makeStringLit("AS_SOL"); strLit__28169; }));
            
        }
        //#line 24 "/home/artica/Documents/Maestria/Implementacion/codigo/COPSolver-V_2.0/src/cpls/HeuristicFactory.x10"
        case 3/*::cpls::CPLSOptionsEnum__HeuristicsSupported::FMGL(EO_SOL__get)()*/: ;
        {
            return (__extension__ ({ static ::x10::lang::String* strLit__28170 = ::x10aux::makeStringLit("EO_SOL"); strLit__28170; }));
            
        }
        //#line 25 "/home/artica/Documents/Maestria/Implementacion/codigo/COPSolver-V_2.0/src/cpls/HeuristicFactory.x10"
        case 4/*::cpls::CPLSOptionsEnum__HeuristicsSupported::FMGL(RoTS_SOL__get)()*/: ;
        {
            return (__extension__ ({ static ::x10::lang::String* strLit__28171 = ::x10aux::makeStringLit("RoTS_SOL"); strLit__28171; }));
            
        }
        //#line 26 "/home/artica/Documents/Maestria/Implementacion/codigo/COPSolver-V_2.0/src/cpls/HeuristicFactory.x10"
        case 1/*::cpls::CPLSOptionsEnum__HeuristicsSupported::FMGL(RS_SOL__get)()*/: ;
        {
            return (__extension__ ({ static ::x10::lang::String* strLit__28172 = ::x10aux::makeStringLit("RS_SOL"); strLit__28172; }));
            
        }
        //#line 27 "/home/artica/Documents/Maestria/Implementacion/codigo/COPSolver-V_2.0/src/cpls/HeuristicFactory.x10"
        default: ;
        {
            return (__extension__ ({ static ::x10::lang::String* strLit__28173 = ::x10aux::makeStringLit("Default"); strLit__28173; }));
            
        }
    }
}

//#line 10 "/home/artica/Documents/Maestria/Implementacion/codigo/COPSolver-V_2.0/src/cpls/HeuristicFactory.x10"
::x10::lang::String* cpls::HeuristicFactory::typeName(){
    return ::x10aux::type_name((*this));
}
::x10::lang::String* cpls::HeuristicFactory::toString() {
    return (__extension__ ({ static ::x10::lang::String* strLit__28174 = ::x10aux::makeStringLit("struct cpls.HeuristicFactory"); strLit__28174; }));
