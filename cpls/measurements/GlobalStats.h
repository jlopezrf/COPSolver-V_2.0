...
class GlobalStats : public ::x10::lang::X10Class   {
    ...
    x10_int FMGL(explorerWinner);
    
    virtual void setExplorerWinner(x10_int explorerWinner);
    virtual x10_int getExplorerWinner();
    ...
    x10_int FMGL(changeForDiv);
    
    virtual void setChangeForDiv(x10_int changeForDiv);
    virtual x10_int getChangeForDiv();
    ...
    virtual void setStats(x10_long co, x10_int p, x10_int e, x10_double t,
                          ...
                          x10_int sa, x10_int rs, x10_int ch, x10_int chFDiv,
                          x10_int fr, x10_int gr, x10_boolean target, x10_int fft,
                          x10_long vs, ::x10::lang::Rail< x10_int >* ss);
    ...
    virtual void printChangesForDivs();
