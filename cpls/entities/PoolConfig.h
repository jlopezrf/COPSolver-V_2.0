...
class PoolConfig : public ::x10::lang::X10Class   {
    ...
    virtual void setProblemSize(x10_long problemSize);
    virtual void setPoolSize(x10_int poolSize);
    virtual void setPoolMode(x10_int poolMode);
    virtual void setMinDist(x10_double minDist);
