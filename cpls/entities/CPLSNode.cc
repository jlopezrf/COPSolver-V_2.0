...
//#line 7 "/home/jason/Documents/Maestria/Implementacion/X10/2-4-2/x10dt/workspace/COPSolver-V_2.0/cpls/entities/CPLSNode.x10"

//#line 9 "/home/jason/Documents/Maestria/Implementacion/X10/2-4-2/x10dt/workspace/COPSolver-V_2.0/cpls/entities/CPLSNode.x10"

//#line 11 "/home/jason/Documents/Maestria/Implementacion/X10/2-4-2/x10dt/workspace/COPSolver-V_2.0/cpls/entities/CPLSNode.x10"

//#line 12 "/home/jason/Documents/Maestria/Implementacion/X10/2-4-2/x10dt/workspace/COPSolver-V_2.0/cpls/entities/CPLSNode.x10"

//#line 14 "/home/jason/Documents/Maestria/Implementacion/X10/2-4-2/x10dt/workspace/COPSolver-V_2.0/cpls/entities/CPLSNode.x10"
void cpls::entities::CPLSNode::_constructor(x10_int nodeRole) {
    
    //#line 15 "/home/jason/Documents/Maestria/Implementacion/X10/2-4-2/x10dt/workspace/COPSolver-V_2.0/cpls/entities/CPLSNode.x10"
    FMGL(nodeRole) = nodeRole;
    
    //#line 7 "/home/jason/Documents/Maestria/Implementacion/X10/2-4-2/x10dt/workspace/COPSolver-V_2.0/cpls/entities/CPLSNode.x10"
    ::cpls::entities::CPLSNode* this__5 = this;
    ::x10aux::nullCheck(this__5)->FMGL(nodeConfig) = ::x10aux::nullCheck(this__5)->FMGL(nodeRole);
    ::x10aux::nullCheck(this__5)->FMGL(heuristicSolver) = (::x10aux::class_cast_unchecked< ::cpls::solver::HeuristicSolver*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    ::x10aux::nullCheck(this__5)->FMGL(problemModel) = (::x10aux::class_cast_unchecked< ::cpls::problem::ProblemGenericModel*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
}
...
//#line 18 "/home/jason/Documents/Maestria/Implementacion/X10/2-4-2/x10dt/workspace/COPSolver-V_2.0/cpls/entities/CPLSNode.x10"
void cpls::entities::CPLSNode::initialize() {
 
}

//#line 22 "/home/jason/Documents/Maestria/Implementacion/X10/2-4-2/x10dt/workspace/COPSolver-V_2.0/cpls/entities/CPLSNode.x10"
void cpls::entities::CPLSNode::setHeuristicSolver(::cpls::solver::HeuristicSolver* hs) {
    
    //#line 23 "/home/jason/Documents/Maestria/Implementacion/X10/2-4-2/x10dt/workspace/COPSolver-V_2.0/cpls/entities/CPLSNode.x10"
    this->FMGL(heuristicSolver) = hs;
}

//#line 26 "/home/jason/Documents/Maestria/Implementacion/X10/2-4-2/x10dt/workspace/COPSolver-V_2.0/cpls/entities/CPLSNode.x10"
void cpls::entities::CPLSNode::setProblemModel(::cpls::problem::ProblemGenericModel* pm) {
    
    //#line 27 "/home/jason/Documents/Maestria/Implementacion/X10/2-4-2/x10dt/workspace/COPSolver-V_2.0/cpls/entities/CPLSNode.x10"
