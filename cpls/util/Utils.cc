...
void cpls::util::Utils::show(::x10::lang::String* s, ::x10::lang::Rail< x10_int >* d) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->print(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(s, (__extension__ ({ static ::x10::lang::String* strLit__27269 = ::x10aux::makeStringLit(" in "); strLit__27269; }))), ::x10::lang::Place::_make(::x10aux::here)->FMGL(id)), (__extension__ ({ static ::x10::lang::String* strLit__27270 = ::x10aux::makeStringLit(" : "); strLit__27270; }))));
    
    //#line 8 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/util/Utils.x10"
    ::x10::lang::Rail< x10_int >* rail__26195 = d;
    x10_long i__26179min__26196 = ((x10_long)0ll);
    x10_long i__26179max__26197 = (x10_long)(::x10aux::nullCheck(rail__26195)->FMGL(size));
    {
        x10_long i__26198;
        for (i__26198 = i__26179min__26196; ((i__26198) < (i__26179max__26197));
             i__26198 = ((i__26198) + (((x10_long)1ll)))) {
            x10_long k__26199 = i__26198;
            
            //#line 9 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/util/Utils.x10"
            ::x10::io::Console::FMGL(OUT__get)()->print(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__27271 = ::x10aux::makeStringLit(" "); strLit__27271; })), ::x10aux::nullCheck(d)->x10::lang::Rail< x10_int >::__apply(
                                                                                                                                                                                                      k__26199)));
        }
    }
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__27273 = ::x10aux::makeStringLit(""); strLit__27273; }))));
}
