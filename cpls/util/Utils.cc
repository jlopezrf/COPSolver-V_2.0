...
void cpls::util::Utils::show(::x10::lang::String* s, ::x10::lang::Rail< x10_int >* d) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->print(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(s, (__extension__ ({ static ::x10::lang::String* strLit__38955 = ::x10aux::makeStringLit(" in "); strLit__38955; }))), ::x10::lang::Place::_make(::x10aux::here)->FMGL(id)), (__extension__ ({ static ::x10::lang::String* strLit__38956 = ::x10aux::makeStringLit(" : "); strLit__38956; }))));
    
    //#line 8 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/util/Utils.x10"
    ::x10::lang::Rail< x10_int >* rail__35149 = d;
    x10_long i__35133min__35150 = ((x10_long)0ll);
    x10_long i__35133max__35151 = (x10_long)(::x10aux::nullCheck(rail__35149)->FMGL(size));
    {
        x10_long i__35152;
        for (i__35152 = i__35133min__35150; ((i__35152) < (i__35133max__35151));
             i__35152 = ((i__35152) + (((x10_long)1ll)))) {
            x10_long k__35153 = i__35152;
            
            //#line 9 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/util/Utils.x10"
            ::x10::io::Console::FMGL(OUT__get)()->print(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__38957 = ::x10aux::makeStringLit(" "); strLit__38957; })), ::x10aux::nullCheck(d)->x10::lang::Rail< x10_int >::__apply(
                                                                                                                                                                                                      k__35153)));
        }
    }
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__38959 = ::x10aux::makeStringLit(""); strLit__38959; }))));
}
