...
void cpls::util::Utils::show(::x10::lang::String* s, ::x10::lang::Rail< x10_int >* d) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->print(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(s, (__extension__ ({ static ::x10::lang::String* strLit__25835 = ::x10aux::makeStringLit(" in "); strLit__25835; }))), ::x10::lang::Place::_make(::x10aux::here)->FMGL(id)), (__extension__ ({ static ::x10::lang::String* strLit__25836 = ::x10aux::makeStringLit(" : "); strLit__25836; }))));
    
    //#line 8 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/util/Utils.x10"
    ::x10::lang::Rail< x10_int >* rail__24817 = d;
    x10_long i__24801min__24818 = ((x10_long)0ll);
    x10_long i__24801max__24819 = (x10_long)(::x10aux::nullCheck(rail__24817)->FMGL(size));
    {
        x10_long i__24820;
        for (i__24820 = i__24801min__24818; ((i__24820) < (i__24801max__24819));
             i__24820 = ((i__24820) + (((x10_long)1ll)))) {
            x10_long k__24821 = i__24820;
            
            //#line 9 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/util/Utils.x10"
            ::x10::io::Console::FMGL(OUT__get)()->print(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__25837 = ::x10aux::makeStringLit(" "); strLit__25837; })), ::x10aux::nullCheck(d)->x10::lang::Rail< x10_int >::__apply(
                                                                                                                                                                                                      k__24821)));
        }
    }
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__25839 = ::x10aux::makeStringLit(""); strLit__25839; }))));
}
