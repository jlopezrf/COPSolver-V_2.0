...
void cpls::util::Utils::show(::x10::lang::String* s, ::x10::lang::Rail< x10_int >* d) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->print(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(s, (__extension__ ({ static ::x10::lang::String* strLit__39587 = ::x10aux::makeStringLit(" in "); strLit__39587; }))), ::x10::lang::Place::_make(::x10aux::here)->FMGL(id)), (__extension__ ({ static ::x10::lang::String* strLit__39588 = ::x10aux::makeStringLit(" : "); strLit__39588; }))));
    
    //#line 8 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/util/Utils.x10"
    ::x10::lang::Rail< x10_int >* rail__35675 = d;
    x10_long i__35659min__35676 = ((x10_long)0ll);
    x10_long i__35659max__35677 = (x10_long)(::x10aux::nullCheck(rail__35675)->FMGL(size));
    {
        x10_long i__35678;
        for (i__35678 = i__35659min__35676; ((i__35678) < (i__35659max__35677));
             i__35678 = ((i__35678) + (((x10_long)1ll)))) {
            x10_long k__35679 = i__35678;
            
            //#line 9 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/util/Utils.x10"
            ::x10::io::Console::FMGL(OUT__get)()->print(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__39589 = ::x10aux::makeStringLit(" "); strLit__39589; })), ::x10aux::nullCheck(d)->x10::lang::Rail< x10_int >::__apply(
                                                                                                                                                                                                      k__35679)));
        }
    }
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__39591 = ::x10aux::makeStringLit(""); strLit__39591; }))));
}
