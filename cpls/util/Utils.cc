...
void cpls::util::Utils::show(::x10::lang::String* s, ::x10::lang::Rail< x10_int >* d) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->print(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(s, (__extension__ ({ static ::x10::lang::String* strLit__29054 = ::x10aux::makeStringLit(" in "); strLit__29054; }))), ::x10::lang::Place::_make(::x10aux::here)->FMGL(id)), (__extension__ ({ static ::x10::lang::String* strLit__29055 = ::x10aux::makeStringLit(" : "); strLit__29055; }))));
    
    //#line 8 "/home/artica/Documents/Maestria/Implementacion/codigo/COPSolver-V_2.0/src/cpls/util/Utils.x10"
    ::x10::lang::Rail< x10_int >* rail__26413 = d;
    x10_long i__26397min__26414 = ((x10_long)0ll);
    x10_long i__26397max__26415 = (x10_long)(::x10aux::nullCheck(rail__26413)->FMGL(size));
    {
        x10_long i__26416;
        for (i__26416 = i__26397min__26414; ((i__26416) < (i__26397max__26415));
             i__26416 = ((i__26416) + (((x10_long)1ll)))) {
            x10_long k__26417 = i__26416;
            
            //#line 9 "/home/artica/Documents/Maestria/Implementacion/codigo/COPSolver-V_2.0/src/cpls/util/Utils.x10"
            ::x10::io::Console::FMGL(OUT__get)()->print(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__29056 = ::x10aux::makeStringLit(" "); strLit__29056; })), ::x10aux::nullCheck(d)->x10::lang::Rail< x10_int >::__apply(
                                                                                                                                                                                                      k__26417)));
        }
    }
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__29058 = ::x10aux::makeStringLit(""); strLit__29058; }))));
}
