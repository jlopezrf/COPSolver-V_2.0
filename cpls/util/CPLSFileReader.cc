...
class cpls_util_CPLSFileReader__closure__1 : public ::x10::lang::Closure {
    ...
    ::x10::lang::String* __apply() {
        return (__extension__ ({ static ::x10::lang::String* strLit__43909 = ::x10aux::makeStringLit("solving all problems into this directory"); strLit__43909; }));
    ...
    const char* toNativeString() {
        return "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10:47";
    }
...
//#line 9 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
::x10::lang::Rail< x10_long >* cpls::util::CPLSFileReader::tryReadParameters(
  ::x10::lang::String* filePath, ::x10::lang::Rail< x10_long >* params) {
    
    //#line 10 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    ::x10::io::File* filep = ::x10::io::File::_make(filePath);
    
    //#line 11 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    ::x10::io::FileReader* fr = filep->openRead();
    
    //#line 12 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    ::x10::lang::String* fLine;
    
    //#line 13 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    do {
        
        //#line 14 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
        fLine = ::x10aux::nullCheck(fr)->readLine();
    } while ((::x10aux::struct_equals((fLine)->charAt(((x10_int)0)), ((x10_char)'#'))));
    
    //#line 16 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    ::x10::lang::Rail< x10_int >* header = ::cpls::util::CPLSFileReader::readParameters(
                                             fLine);
    
    //#line 18 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    {
        x10_long i;
        for (i = ((x10_long)0ll); ((i) < ((x10_long)(::x10aux::nullCheck(params)->FMGL(size))));
             i = ((i) + (((x10_long)1ll)))) {
            
            //#line 19 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    ...
    //#line 21 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    ::x10aux::nullCheck(fr)->close();
    
    //#line 22 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    return params;
    
}

//#line 25 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
::x10::lang::Rail< x10_int >* cpls::util::CPLSFileReader::readParameters(
  ::x10::lang::String* line) {
    
    //#line 26 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    x10_int i;
    
    //#line 27 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    x10_int j = ((x10_int)0);
    
    //#line 28 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    ::x10::lang::String* buffer = (__extension__ ({ static ::x10::lang::String* strLit__43907 = ::x10aux::makeStringLit(""); strLit__43907; }));
    
    //#line 29 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    ::x10::lang::Rail< x10_int >* x = ::x10::lang::Rail< x10_int >::_make(((x10_long)3ll),
                                                                          ((x10_int)-1));
    
    //#line 30 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    {
        for (i = ((x10_int)0); ((i) < (::x10aux::nullCheck(line)->x10::lang::String::length()));
             i = ((i) + (((x10_int)1)))) {
            
            //#line 31 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
                                         ...
                                         ((x10_char)'\n')))))
            {
                ...
                //#line 32 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
                ...
                //#line 33 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
                buffer = (__extension__ ({ static ::x10::lang::String* strLit__43908 = ::x10aux::makeStringLit(""); strLit__43908; }));
            } else {
                
                //#line 35 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    ...
    //#line 38 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    x->x10::lang::Rail< x10_int >::__set(((x10_long)(j)),
                                         ::x10::lang::IntNatives::parseInt(buffer));
    
    //#line 39 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    return x;
    
}

//#line 42 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
::x10::lang::Rail< ::x10::lang::String* >* cpls::util::CPLSFileReader::loadDir(
  ::x10::lang::String* path) {
    
    //#line 43 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    ::x10::util::StringBuilder* nPath = ::x10::util::StringBuilder::_make();
    
    //#line 44 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    ::x10::io::File* fp = ::x10::io::File::_make(path);
    
    //#line 45 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    ::x10::lang::Rail< ::x10::lang::String* >* execList;
    
    //#line 46 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    if (fp->isDirectory()) {
        
        //#line 47 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
        ...
        //#line 48 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
        execList = fp->list();
        
        //#line 49 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
        ::x10aux::nullCheck(nPath)->addString(path);
    } else {
        
        //#line 52 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
        execList = (__extension__ ({
            ::x10::lang::Rail< ::x10::lang::String* >* t__43903 =
              ::x10::lang::Rail< ::x10::lang::String* >::_makeUnsafe(((x10_long)1ll), false);
            t__43903->x10::lang::Rail< ::x10::lang::String* >::__set(
              ((x10_long)0ll), fp->getName());
            t__43903;
        }))
        ;
        
        //#line 53 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
        ::x10aux::nullCheck(nPath)->addString(::x10aux::nullCheck(fp->getParentFile())->getPath());
        
        //#line 54 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
        ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
          reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus(::x10::lang::String::__plus(nPath, (__extension__ ({ static ::x10::lang::String* strLit__43910 = ::x10aux::makeStringLit(" "); strLit__43910; }))), fp->getName())));
    }
    
    //#line 56 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    ::x10::util::RailUtils::sort< ::x10::lang::String* >(
      execList);
    
    //#line 57 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
    return execList;
    
}

//#line 7 "/home/jason/COPSolver-V_2.0/src/cpls/util/CPLSFileReader.x10"
