...
#ifndef CPLS_UTIL_MONITOR_H_atomicBlock_481
#define CPLS_UTIL_MONITOR_H_atomicBlock_481
...
#endif // CPLS_UTIL_MONITOR_H_atomicBlock_481
#ifndef CPLS_UTIL_MONITOR_H_on_482
#define CPLS_UTIL_MONITOR_H_on_482
template<class TPMGL(T)> TPMGL(T) cpls::util::Monitor::on(::x10::lang::Fun_0_0<x10_boolean>* cond,
                                                          ::x10::lang::Fun_0_0<TPMGL(T)>* action) {
    {
        ...
        ::x10::lang::CheckedThrowable* throwable__35483 =
        ...
        catch (::x10::lang::CheckedThrowable* __exc483) {
            if (true) {
                ::x10::lang::CheckedThrowable* formal__35484 =
                  static_cast< ::x10::lang::CheckedThrowable*>(__exc483);
                {
                    throwable__35483 = formal__35484;
                }
            } else
            throw;
        }
        if ((!::x10aux::struct_equals(reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL),
                                      throwable__35483)))
        {
            if (::x10aux::instanceof< ::x10::compiler::Abort*>(throwable__35483))
            {
                ::x10aux::throwException(::x10aux::nullCheck(throwable__35483));
            }
        ...
        if ((!::x10aux::struct_equals(reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL),
                                      throwable__35483)))
        {
            if (!(::x10aux::instanceof< ::x10::compiler::Finalization*>(throwable__35483)))
            {
                ::x10aux::throwException(::x10aux::nullCheck(throwable__35483));
            }
...
#endif // CPLS_UTIL_MONITOR_H_on_482
