...
#ifndef CPLS_UTIL_MONITOR_H_atomicBlock_474
#define CPLS_UTIL_MONITOR_H_atomicBlock_474
...
#endif // CPLS_UTIL_MONITOR_H_atomicBlock_474
#ifndef CPLS_UTIL_MONITOR_H_on_475
#define CPLS_UTIL_MONITOR_H_on_475
template<class TPMGL(T)> TPMGL(T) cpls::util::Monitor::on(::x10::lang::Fun_0_0<x10_boolean>* cond,
                                                          ::x10::lang::Fun_0_0<TPMGL(T)>* action) {
    {
        ...
        ::x10::lang::CheckedThrowable* throwable__34957 =
        ...
        catch (::x10::lang::CheckedThrowable* __exc476) {
            if (true) {
                ::x10::lang::CheckedThrowable* formal__34958 =
                  static_cast< ::x10::lang::CheckedThrowable*>(__exc476);
                {
                    throwable__34957 = formal__34958;
                }
            } else
            throw;
        }
        if ((!::x10aux::struct_equals(reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL),
                                      throwable__34957)))
        {
            if (::x10aux::instanceof< ::x10::compiler::Abort*>(throwable__34957))
            {
                ::x10aux::throwException(::x10aux::nullCheck(throwable__34957));
            }
        ...
        if ((!::x10aux::struct_equals(reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL),
                                      throwable__34957)))
        {
            if (!(::x10aux::instanceof< ::x10::compiler::Finalization*>(throwable__34957)))
            {
                ::x10aux::throwException(::x10aux::nullCheck(throwable__34957));
            }
...
#endif // CPLS_UTIL_MONITOR_H_on_475
