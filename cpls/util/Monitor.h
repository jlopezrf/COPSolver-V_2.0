...
#ifndef CPLS_UTIL_MONITOR_H_atomicBlock_483
#define CPLS_UTIL_MONITOR_H_atomicBlock_483
...
#endif // CPLS_UTIL_MONITOR_H_atomicBlock_483
#ifndef CPLS_UTIL_MONITOR_H_on_484
#define CPLS_UTIL_MONITOR_H_on_484
template<class TPMGL(T)> TPMGL(T) cpls::util::Monitor::on(::x10::lang::Fun_0_0<x10_boolean>* cond,
                                                          ::x10::lang::Fun_0_0<TPMGL(T)>* action) {
    {
        ...
        ::x10::lang::CheckedThrowable* throwable__37892 =
        ...
        catch (::x10::lang::CheckedThrowable* __exc485) {
            if (true) {
                ::x10::lang::CheckedThrowable* formal__37893 =
                  static_cast< ::x10::lang::CheckedThrowable*>(__exc485);
                {
                    throwable__37892 = formal__37893;
                }
            } else
            throw;
        }
        if ((!::x10aux::struct_equals(reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL),
                                      throwable__37892)))
        {
            if (::x10aux::instanceof< ::x10::compiler::Abort*>(throwable__37892))
            {
                ::x10aux::throwException(::x10aux::nullCheck(throwable__37892));
            }
        ...
        if ((!::x10aux::struct_equals(reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL),
                                      throwable__37892)))
        {
            if (!(::x10aux::instanceof< ::x10::compiler::Finalization*>(throwable__37892)))
            {
                ::x10aux::throwException(::x10aux::nullCheck(throwable__37892));
            }
...
#endif // CPLS_UTIL_MONITOR_H_on_484
