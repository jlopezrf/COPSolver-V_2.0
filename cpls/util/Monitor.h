...
#ifndef CPLS_UTIL_MONITOR_H_atomicBlock_364
#define CPLS_UTIL_MONITOR_H_atomicBlock_364
...
#endif // CPLS_UTIL_MONITOR_H_atomicBlock_364
#ifndef CPLS_UTIL_MONITOR_H_on_365
#define CPLS_UTIL_MONITOR_H_on_365
template<class TPMGL(T)> TPMGL(T) cpls::util::Monitor::on(::x10::lang::Fun_0_0<x10_boolean>* cond,
                                                          ::x10::lang::Fun_0_0<TPMGL(T)>* action) {
    {
        ...
        ::x10::lang::CheckedThrowable* throwable__24714 =
        ...
        try {
            ...
            if (true) {
                ::x10::lang::CheckedThrowable* formal__24715 =
                  static_cast< ::x10::lang::CheckedThrowable*>(__exc366);
                {
                    throwable__24714 = formal__24715;
                }
            } else
            throw;
        }
        if ((!::x10aux::struct_equals(reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL),
                                      throwable__24714)))
        {
            if (::x10aux::instanceof< ::x10::compiler::Abort*>(throwable__24714))
            {
                ::x10aux::throwException(::x10aux::nullCheck(throwable__24714));
            }
        ...
        if ((!::x10aux::struct_equals(reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL),
                                      throwable__24714)))
        {
            if (!(::x10aux::instanceof< ::x10::compiler::Finalization*>(throwable__24714)))
            {
                ::x10aux::throwException(::x10aux::nullCheck(throwable__24714));
            }
...
#endif // CPLS_UTIL_MONITOR_H_on_365
