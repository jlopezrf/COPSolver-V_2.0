...
template<class TPMGL(T)> TPMGL(T) cpls::util::Monitor::on(::x10::lang::Fun_0_0<x10_boolean>* cond,
                                                          ::x10::lang::Fun_0_0<TPMGL(T)>* action) {
    {
        ...
        //#line 65 "/home/jason/COPSolver-V_2.0/src/cpls/util/Monitor.x10"
        ::x10::lang::CheckedThrowable* throwable__39414 =
          ::x10aux::class_cast_unchecked< ::x10::lang::CheckedThrowable*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL));
        try {
            {
                
                //#line 66 "/home/jason/COPSolver-V_2.0/src/cpls/util/Monitor.x10"
                this->lock();
                
                //#line 69 "/home/jason/COPSolver-V_2.0/src/cpls/util/Monitor.x10"
                while (!(::x10::lang::Fun_0_0<x10_boolean>::__apply(::x10aux::nullCheck(cond))))
                {
                    
                    //#line 70 "/home/jason/COPSolver-V_2.0/src/cpls/util/Monitor.x10"
                    ::x10::lang::Runtime__Worker* thisWorker =
                      ::x10::lang::Runtime::worker();
                    
                    //#line 71 "/home/jason/COPSolver-V_2.0/src/cpls/util/Monitor.x10"
                    x10_int s = this->FMGL(size);
                    
                    //#line 72 "/home/jason/COPSolver-V_2.0/src/cpls/util/Monitor.x10"
                    ...
                    //#line 73 "/home/jason/COPSolver-V_2.0/src/cpls/util/Monitor.x10"
                    while ((::x10aux::struct_equals(this->FMGL(threads)->x10::lang::template Rail< ::x10::lang::Runtime__Worker* >::__apply(
                                                      ((x10_long)(s))),
                                                    thisWorker)))
                    {
                        
                        //#line 74 "/home/jason/COPSolver-V_2.0/src/cpls/util/Monitor.x10"
                        ::cpls::util::Logger::log(::cpls::util::Monitor::FMGL(suspending__get)());
                        
                        //#line 75 "/home/jason/COPSolver-V_2.0/src/cpls/util/Monitor.x10"
                        this->unlock();
                        
                        //#line 76 "/home/jason/COPSolver-V_2.0/src/cpls/util/Monitor.x10"
                        ::x10::lang::Runtime__Worker::park();
                        
                        //#line 78 "/home/jason/COPSolver-V_2.0/src/cpls/util/Monitor.x10"
                        this->lock();
                    }
                    
                }
                
                //#line 82 "/home/jason/COPSolver-V_2.0/src/cpls/util/Monitor.x10"
                TPMGL(T) result = ::x10::lang::Fun_0_0<TPMGL(T)>::__apply(::x10aux::nullCheck(action));
                
                //#line 84 "/home/jason/COPSolver-V_2.0/src/cpls/util/Monitor.x10"
                x10_int m = this->FMGL(size);
                
                //#line 86 "/home/jason/COPSolver-V_2.0/src/cpls/util/Monitor.x10"
                {
                    x10_int i;
                                                          ...
                                                          ((i) + (((x10_int)1))))
                    {
                        ...
                        //#line 87 "/home/jason/COPSolver-V_2.0/src/cpls/util/Monitor.x10"
                        this->FMGL(size) = ((this->FMGL(size)) - (((x10_int)1)));
                        
                        //#line 90 "/home/jason/COPSolver-V_2.0/src/cpls/util/Monitor.x10"
                        ...
                        //#line 91 "/home/jason/COPSolver-V_2.0/src/cpls/util/Monitor.x10"
                        this->FMGL(threads)->x10::lang::template Rail< ::x10::lang::Runtime__Worker* >::__set(
                ...
                }
                {
                    ...
                    //#line 94 "/home/jason/COPSolver-V_2.0/src/cpls/util/Monitor.x10"
                    TPMGL(T) t__39413 = result;
                    {
                        
                        //#line 96 "/home/jason/COPSolver-V_2.0/src/cpls/util/Monitor.x10"
                        this->unlock();
                    }
                    return t__39413;
            ...
            if (true) {
                ::x10::lang::CheckedThrowable* formal__39415 =
                  static_cast< ::x10::lang::CheckedThrowable*>(__exc487);
                {
                    throwable__39414 = formal__39415;
                }
            } else
            throw;
        }
        if ((!::x10aux::struct_equals(reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL),
                                      throwable__39414)))
        {
            if (::x10aux::instanceof< ::x10::compiler::Abort*>(throwable__39414))
            {
                ::x10aux::throwException(::x10aux::nullCheck(throwable__39414));
            }
            
        }
        
        //#line 95 "/home/jason/COPSolver-V_2.0/src/cpls/util/Monitor.x10"
        if (true) {
        ...
        if ((!::x10aux::struct_equals(reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL),
                                      throwable__39414)))
        {
            if (!(::x10aux::instanceof< ::x10::compiler::Finalization*>(throwable__39414)))
            {
                ::x10aux::throwException(::x10aux::nullCheck(throwable__39414));
            }
