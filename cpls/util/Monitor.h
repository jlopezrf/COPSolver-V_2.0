...
#ifndef CPLS_UTIL_MONITOR_H_atomicBlock_503
#define CPLS_UTIL_MONITOR_H_atomicBlock_503
...
#endif // CPLS_UTIL_MONITOR_H_atomicBlock_503
#ifndef CPLS_UTIL_MONITOR_H_on_504
#define CPLS_UTIL_MONITOR_H_on_504
template<class TPMGL(T)> TPMGL(T) cpls::util::Monitor::on(::x10::lang::Fun_0_0<x10_boolean>* cond,
                                                          ::x10::lang::Fun_0_0<TPMGL(T)>* action) {
    {
        ...
        ::x10::lang::CheckedThrowable* throwable__32543 =
        ...
        catch (::x10::lang::CheckedThrowable* __exc505) {
            if (true) {
                ::x10::lang::CheckedThrowable* formal__32544 =
                  static_cast< ::x10::lang::CheckedThrowable*>(__exc505);
                {
                    throwable__32543 = formal__32544;
                }
            } else
            throw;
        }
        if ((!::x10aux::struct_equals(reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL),
                                      throwable__32543)))
        {
            if (::x10aux::instanceof< ::x10::compiler::Abort*>(throwable__32543))
            {
                ::x10aux::throwException(::x10aux::nullCheck(throwable__32543));
            }
        ...
        if ((!::x10aux::struct_equals(reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL),
                                      throwable__32543)))
        {
            if (!(::x10aux::instanceof< ::x10::compiler::Finalization*>(throwable__32543)))
            {
                ::x10aux::throwException(::x10aux::nullCheck(throwable__32543));
            }
...
#endif // CPLS_UTIL_MONITOR_H_on_504
