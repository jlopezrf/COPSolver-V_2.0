...
#ifndef CPLS_UTIL_MONITOR_H_atomicBlock_485
#define CPLS_UTIL_MONITOR_H_atomicBlock_485
...
#endif // CPLS_UTIL_MONITOR_H_atomicBlock_485
#ifndef CPLS_UTIL_MONITOR_H_on_486
#define CPLS_UTIL_MONITOR_H_on_486
template<class TPMGL(T)> TPMGL(T) cpls::util::Monitor::on(::x10::lang::Fun_0_0<x10_boolean>* cond,
                                                          ::x10::lang::Fun_0_0<TPMGL(T)>* action) {
    {
        ...
        ::x10::lang::CheckedThrowable* throwable__38880 =
        ...
        catch (::x10::lang::CheckedThrowable* __exc487) {
            if (true) {
                ::x10::lang::CheckedThrowable* formal__38881 =
                  static_cast< ::x10::lang::CheckedThrowable*>(__exc487);
                {
                    throwable__38880 = formal__38881;
                }
            } else
            throw;
        }
        if ((!::x10aux::struct_equals(reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL),
                                      throwable__38880)))
        {
            if (::x10aux::instanceof< ::x10::compiler::Abort*>(throwable__38880))
            {
                ::x10aux::throwException(::x10aux::nullCheck(throwable__38880));
            }
        ...
        if ((!::x10aux::struct_equals(reinterpret_cast< ::x10::lang::CheckedThrowable*>(X10_NULL),
                                      throwable__38880)))
        {
            if (!(::x10aux::instanceof< ::x10::compiler::Finalization*>(throwable__38880)))
            {
                ::x10aux::throwException(::x10aux::nullCheck(throwable__38880));
            }
...
#endif // CPLS_UTIL_MONITOR_H_on_486
