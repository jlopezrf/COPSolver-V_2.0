...
void cpls::util::Logger::FMGL(DEBUG__do_init)() {
    ...
    x10_long __var449__ = ((x10_long)0ll);
    FMGL(DEBUG) = __var449__;
...
void cpls::util::Logger::FMGL(LOG__do_init)() {
    ...
    x10_long __var450__ = ((x10_long)1ll);
    FMGL(LOG) = __var450__;
...
void cpls::util::Logger::FMGL(INFO__do_init)() {
    ...
    x10_long __var451__ = ((x10_long)2ll);
    FMGL(INFO) = __var451__;
...
void cpls::util::Logger::FMGL(LEVEL__do_init)() {
    ...
    x10_long __var452__ = ((x10_long)3ll);
    FMGL(LEVEL) = __var452__;
...
void cpls::util::Logger::out(::x10::lang::String* s) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__38921 = ::x10aux::makeStringLit("["); strLit__38921; })), ::x10::lang::Place::_make(::x10aux::here)), (__extension__ ({ static ::x10::lang::String* strLit__38922 = ::x10aux::makeStringLit(":"); strLit__38922; }))), ::x10::lang::Runtime::workerId()), (__extension__ ({ static ::x10::lang::String* strLit__38923 = ::x10aux::makeStringLit(" "); strLit__38923; }))), ::x10::lang::System::nanoTime()), (__extension__ ({ static ::x10::lang::String* strLit__38924 = ::x10aux::makeStringLit("] "); strLit__38924; }))), s)));
}
