...
void cpls::util::Logger::FMGL(DEBUG__do_init)() {
    ...
    x10_long __var367__ = ((x10_long)0ll);
    FMGL(DEBUG) = __var367__;
...
void cpls::util::Logger::FMGL(LOG__do_init)() {
    ...
    x10_long __var368__ = ((x10_long)1ll);
    FMGL(LOG) = __var368__;
...
void cpls::util::Logger::FMGL(INFO__do_init)() {
    ...
    x10_long __var369__ = ((x10_long)2ll);
    FMGL(INFO) = __var369__;
...
void cpls::util::Logger::FMGL(LEVEL__do_init)() {
    ...
    x10_long __var370__ = ((x10_long)3ll);
    FMGL(LEVEL) = __var370__;
...
void cpls::util::Logger::out(::x10::lang::String* s) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__29020 = ::x10aux::makeStringLit("["); strLit__29020; })), ::x10::lang::Place::_make(::x10aux::here)), (__extension__ ({ static ::x10::lang::String* strLit__29021 = ::x10aux::makeStringLit(":"); strLit__29021; }))), ::x10::lang::Runtime::workerId()), (__extension__ ({ static ::x10::lang::String* strLit__29022 = ::x10aux::makeStringLit(" "); strLit__29022; }))), ::x10::lang::System::nanoTime()), (__extension__ ({ static ::x10::lang::String* strLit__29023 = ::x10aux::makeStringLit("] "); strLit__29023; }))), s)));
}
