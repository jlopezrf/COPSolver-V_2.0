...
void cpls::util::Logger::FMGL(DEBUG__do_init)() {
    ...
    x10_long __var487__ = ((x10_long)0ll);
    FMGL(DEBUG) = __var487__;
...
void cpls::util::Logger::FMGL(LOG__do_init)() {
    ...
    x10_long __var488__ = ((x10_long)1ll);
    FMGL(LOG) = __var488__;
...
void cpls::util::Logger::FMGL(INFO__do_init)() {
    ...
    x10_long __var489__ = ((x10_long)2ll);
    FMGL(INFO) = __var489__;
...
void cpls::util::Logger::FMGL(LEVEL__do_init)() {
    ...
    x10_long __var490__ = ((x10_long)3ll);
    FMGL(LEVEL) = __var490__;
...
void cpls::util::Logger::out(::x10::lang::String* s) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__34385 = ::x10aux::makeStringLit("["); strLit__34385; })), ::x10::lang::Place::_make(::x10aux::here)), (__extension__ ({ static ::x10::lang::String* strLit__34386 = ::x10aux::makeStringLit(":"); strLit__34386; }))), ::x10::lang::Runtime::workerId()), (__extension__ ({ static ::x10::lang::String* strLit__34387 = ::x10aux::makeStringLit(" "); strLit__34387; }))), ::x10::lang::System::nanoTime()), (__extension__ ({ static ::x10::lang::String* strLit__34388 = ::x10aux::makeStringLit("] "); strLit__34388; }))), s)));
}
