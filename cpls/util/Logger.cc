...
void cpls::util::Logger::FMGL(DEBUG__do_init)() {
    ...
    x10_long __var339__ = ((x10_long)0ll);
    FMGL(DEBUG) = __var339__;
...
void cpls::util::Logger::FMGL(LOG__do_init)() {
    ...
    x10_long __var340__ = ((x10_long)1ll);
    FMGL(LOG) = __var340__;
...
void cpls::util::Logger::FMGL(INFO__do_init)() {
    ...
    x10_long __var341__ = ((x10_long)2ll);
    FMGL(INFO) = __var341__;
...
void cpls::util::Logger::FMGL(LEVEL__do_init)() {
    ...
    x10_long __var342__ = ((x10_long)3ll);
    FMGL(LEVEL) = __var342__;
...
void cpls::util::Logger::out(::x10::lang::String* s) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__25863 = ::x10aux::makeStringLit("["); strLit__25863; })), ::x10::lang::Place::_make(::x10aux::here)), (__extension__ ({ static ::x10::lang::String* strLit__25864 = ::x10aux::makeStringLit(":"); strLit__25864; }))), ::x10::lang::Runtime::workerId()), (__extension__ ({ static ::x10::lang::String* strLit__25865 = ::x10aux::makeStringLit(" "); strLit__25865; }))), ::x10::lang::System::nanoTime()), (__extension__ ({ static ::x10::lang::String* strLit__25866 = ::x10aux::makeStringLit("] "); strLit__25866; }))), s)));
}
