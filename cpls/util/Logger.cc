...
void cpls::util::Logger::FMGL(DEBUG__do_init)() {
    ...
    x10_long __var403__ = ((x10_long)0ll);
    FMGL(DEBUG) = __var403__;
...
void cpls::util::Logger::FMGL(LOG__do_init)() {
    ...
    x10_long __var404__ = ((x10_long)1ll);
    FMGL(LOG) = __var404__;
...
void cpls::util::Logger::FMGL(INFO__do_init)() {
    ...
    x10_long __var405__ = ((x10_long)2ll);
    FMGL(INFO) = __var405__;
...
void cpls::util::Logger::FMGL(LEVEL__do_init)() {
    ...
    x10_long __var406__ = ((x10_long)3ll);
    FMGL(LEVEL) = __var406__;
...
void cpls::util::Logger::out(::x10::lang::String* s) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__39889 = ::x10aux::makeStringLit("["); strLit__39889; })), ::x10::lang::Place::_make(::x10aux::here)), (__extension__ ({ static ::x10::lang::String* strLit__39890 = ::x10aux::makeStringLit(":"); strLit__39890; }))), ::x10::lang::Runtime::workerId()), (__extension__ ({ static ::x10::lang::String* strLit__39891 = ::x10aux::makeStringLit(" "); strLit__39891; }))), ::x10::lang::System::nanoTime()), (__extension__ ({ static ::x10::lang::String* strLit__39892 = ::x10aux::makeStringLit("] "); strLit__39892; }))), s)));
}
