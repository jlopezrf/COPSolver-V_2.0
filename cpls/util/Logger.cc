...
void cpls::util::Logger::FMGL(DEBUG__do_init)() {
    ...
    x10_long __var461__ = ((x10_long)0ll);
    FMGL(DEBUG) = __var461__;
...
void cpls::util::Logger::FMGL(LOG__do_init)() {
    ...
    x10_long __var462__ = ((x10_long)1ll);
    FMGL(LOG) = __var462__;
...
void cpls::util::Logger::FMGL(INFO__do_init)() {
    ...
    x10_long __var463__ = ((x10_long)2ll);
    FMGL(INFO) = __var463__;
...
void cpls::util::Logger::FMGL(LEVEL__do_init)() {
    ...
    x10_long __var464__ = ((x10_long)3ll);
    FMGL(LEVEL) = __var464__;
...
void cpls::util::Logger::out(::x10::lang::String* s) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__42584 = ::x10aux::makeStringLit("["); strLit__42584; })), ::x10::lang::Place::_make(::x10aux::here)), (__extension__ ({ static ::x10::lang::String* strLit__42585 = ::x10aux::makeStringLit(":"); strLit__42585; }))), ::x10::lang::Runtime::workerId()), (__extension__ ({ static ::x10::lang::String* strLit__42586 = ::x10aux::makeStringLit(" "); strLit__42586; }))), ::x10::lang::System::nanoTime()), (__extension__ ({ static ::x10::lang::String* strLit__42587 = ::x10aux::makeStringLit("] "); strLit__42587; }))), s)));
}
