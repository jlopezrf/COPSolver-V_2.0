...
//#line 3 "/home/jason/COPSolver-V_2.0/src/cpls/util/Unit.x10"
::x10::lang::String* cpls::util::Unit::typeName(){
    return ::x10aux::type_name((*this));
}
::x10::lang::String* cpls::util::Unit::toString() {
    return (__extension__ ({ static ::x10::lang::String* strLit__43937 = ::x10aux::makeStringLit("struct cpls.util.Unit"); strLit__43937; }));
