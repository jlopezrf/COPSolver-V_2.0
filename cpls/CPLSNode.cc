...
void cpls::CPLSNode::_constructor() {
    ...
    this->FMGL(pointersComunication) = (__extension__ ({
        ::x10::util::ArrayList< ::x10::lang::PlaceLocalHandle< ::cpls::CPLSNode*> >* alloc__801 =
        ...
        (alloc__801)->::x10::util::ArrayList< ::x10::lang::PlaceLocalHandle< ::cpls::CPLSNode*> >::_constructor();
        alloc__801;
    }))
    ;
}
...
void cpls::CPLSNode::initialize(::cpls::entities::NodeConfig* config,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__9278 = ::x10aux::makeStringLit("Se inicializa con la heurisica"); strLit__9278; })), (__extension__ ({
          
          //#line 21 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/HeuristicFactory.x10"
          x10_int kind__2072 = ::x10aux::nullCheck(config)->getHeuristic();
          ::x10::lang::String* ret__2073;
          goto __ret__2074; __ret__2074: {
          {
              ...
              switch (kind__2072) {
                  ...
                  case ((x10_int)2): ;
                  {
                      ret__2073 = (__extension__ ({ static ::x10::lang::String* strLit__9279 = ::x10aux::makeStringLit("AS_SOL"); strLit__9279; }));
                      goto __ret__2074_end_;
                  }
                  //#line 24 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/HeuristicFactory.x10"
                  case ((x10_int)3): ;
                  {
                      ret__2073 = (__extension__ ({ static ::x10::lang::String* strLit__9280 = ::x10aux::makeStringLit("EO_SOL"); strLit__9280; }));
                      goto __ret__2074_end_;
                  }
                  //#line 25 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/HeuristicFactory.x10"
                  case ((x10_int)4): ;
                  {
                      ret__2073 = (__extension__ ({ static ::x10::lang::String* strLit__9281 = ::x10aux::makeStringLit("RoTS_SOL"); strLit__9281; }));
                      goto __ret__2074_end_;
                  }
                  //#line 26 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/HeuristicFactory.x10"
                  case ((x10_int)1): ;
                  {
                      ret__2073 = (__extension__ ({ static ::x10::lang::String* strLit__9282 = ::x10aux::makeStringLit("RS_SOL"); strLit__9282; }));
                      goto __ret__2074_end_;
                  }
                  //#line 27 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/HeuristicFactory.x10"
                  default: ;
                  {
                      ret__2073 = (__extension__ ({ static ::x10::lang::String* strLit__9283 = ::x10aux::makeStringLit("Default"); strLit__9283; }));
                      goto __ret__2074_end_;
                  }
              }
          }goto __ret__2074_end_; __ret__2074_end_: ;
          }
          ret__2073;
          }))
          )));
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__9284 = ::x10aux::makeStringLit("Nodo inicializado en el proceso"); strLit__9284; })), idPlace)));
    }
...
void cpls::CPLSNode::configHeuristic(::cpls::problem::ProblemGenericModel* problemModel) {
    ...
    //#line 68 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/CPLSNode.x10"
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__9289 = ::x10aux::makeStringLit("Se ingresa a setear el ProblemModel en "); strLit__9289; })), ::x10::lang::Place::_make(::x10aux::here)->FMGL(id))));
...
void cpls::CPLSNode::start() {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__9290 = ::x10aux::makeStringLit("Se invoca metodo start"); strLit__9290; }))));
...
void cpls::CPLSNode::start(x10_long seedIn, x10_long targetCost,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__9291 = ::x10aux::makeStringLit("Se ingresa al start en "); strLit__9291; })), ::x10::lang::Place::_make(::x10aux::here)->FMGL(id))));
    ...
    if (((strictLow && ((cost) < (targetCost))) || (!(strictLow) &&
        ...
        if (winner) {
            ...
            if (this->FMGL(verify)) {
                ...
                ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
                  reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__9292 = ::x10aux::makeStringLit(", Solution is "); strLit__9292; })), ::x10aux::nullCheck(this->FMGL(heuristicSolver))->verify()
                    ? ((__extension__ ({ static ::x10::lang::String* strLit__9293 = ::x10aux::makeStringLit("perfect !!!"); strLit__9293; })))
                    : ((__extension__ ({ static ::x10::lang::String* strLit__9294 = ::x10aux::makeStringLit("not perfect "); strLit__9294; }))))));
            }
        ...
        this->FMGL(solString) = ::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__9295 = ::x10aux::makeStringLit("Solution "); strLit__9295; })), ::x10::lang::Place::_make(::x10aux::here)), (__extension__ ({ static ::x10::lang::String* strLit__9296 = ::x10aux::makeStringLit(" is "); strLit__9296; }))), ::x10aux::nullCheck(this->FMGL(heuristicSolver))->verify()
          ? ((__extension__ ({ static ::x10::lang::String* strLit__9297 = ::x10aux::makeStringLit("perfect !!!"); strLit__9297; })))
          : ((__extension__ ({ static ::x10::lang::String* strLit__9298 = ::x10aux::makeStringLit("not perfect, maybe wrong ..."); strLit__9298; }))));
        ...
        ::x10::lang::Rail< x10_int >* src__9268 = ::x10aux::nullCheck(this->FMGL(heuristicSolver))->getBestConfiguration();
        ::x10::lang::Rail< x10_int >* dst__9269 = this->FMGL(bestSolHere);
        if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(src__9268)->FMGL(size)),
                                       (x10_long)(::x10aux::nullCheck(dst__9269)->FMGL(size))))))
        {
            ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__9299 = ::x10aux::makeStringLit("!(src$788.size == dst$789.size)"); strLit__9299; })))));
        }
        ::x10::lang::Rail< void >::copy< x10_int >(src__9268,
                                                   dst__9269);
    }
...
x10_boolean cpls::CPLSNode::announceWinner(x10_long p) {
    ...
    if (result) {
        ...
        {
            ::x10::lang::Iterator< ::x10::lang::Place>* k__845;
            for (k__845 = (reinterpret_cast< ::x10::lang::PlaceGroup*>(::x10::lang::PlaceGroup::FMGL(WORLD__get)()))->iterator();
                 ::x10::lang::Iterator< ::x10::lang::Place>::hasNext(::x10aux::nullCheck(k__845));
                 ) {
                ::x10::lang::Place k = ::x10::lang::Iterator< ::x10::lang::Place>::next(::x10aux::nullCheck(k__845));
                ...
                {
                    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
                      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__9300 = ::x10aux::makeStringLit("Ac\341 debo implementar un Kill"); strLit__9300; }))));
                }
...
void cpls::CPLSNode::__fieldInitializers_cpls_CPLSNode() {
    ...
    this->FMGL(stats) = (__extension__ ({
        ...
        //#line 22 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/CPLSNode.x10"
        ::cpls::measurements::GlobalStats* alloc__802 =  (new (::x10aux::alloc_z< ::cpls::measurements::GlobalStats>()) ::cpls::measurements::GlobalStats());
        
        //#line 15 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/measurements/GlobalStats.x10"
        alloc__802->cpls::measurements::GlobalStats::__fieldInitializers_cpls_measurements_GlobalStats();
        alloc__802;
    }))
    ;
    this->FMGL(sampleAccStats) = (__extension__ ({
        ...
        //#line 23 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/CPLSNode.x10"
        ::cpls::measurements::GlobalStats* alloc__803 =  (new (::x10aux::alloc_z< ::cpls::measurements::GlobalStats>()) ::cpls::measurements::GlobalStats());
        
        //#line 15 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/measurements/GlobalStats.x10"
        alloc__803->cpls::measurements::GlobalStats::__fieldInitializers_cpls_measurements_GlobalStats();
        alloc__803;
    }))
    ;
    this->FMGL(genAccStats) = (__extension__ ({
        ...
        //#line 24 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/CPLSNode.x10"
        ::cpls::measurements::GlobalStats* alloc__804 =  (new (::x10aux::alloc_z< ::cpls::measurements::GlobalStats>()) ::cpls::measurements::GlobalStats());
        
        //#line 15 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/measurements/GlobalStats.x10"
        alloc__804->cpls::measurements::GlobalStats::__fieldInitializers_cpls_measurements_GlobalStats();
        alloc__804;
    }))
    ;
