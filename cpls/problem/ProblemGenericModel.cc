...
x10_long cpls::problem::ProblemGenericModel::costOnVariable(x10_long i) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__42971 = ::x10aux::makeStringLit("Error bad costOnVariable"); strLit__42971; }))));
...
x10_long cpls::problem::ProblemGenericModel::costIfSwap(x10_long current_cost,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__42972 = ::x10aux::makeStringLit("Error costIfSwap"); strLit__42972; }))));
...
void cpls::problem::ProblemGenericModel::executedSwap(x10_long sz, x10_long i1,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__42973 = ::x10aux::makeStringLit("Error no executedSwap implementation"); strLit__42973; }))));
}
...
x10_long cpls::problem::ProblemGenericModel::costOfSolution(x10_long sz, x10_boolean shouldBeRecorded,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__42974 = ::x10aux::makeStringLit("Error costOfSolution"); strLit__42974; }))));
...
x10_long cpls::problem::ProblemGenericModel::costOfSolution(x10_long sz,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__42975 = ::x10aux::makeStringLit("Error costOfSolution"); strLit__42975; }))));
...
void cpls::problem::ProblemGenericModel::show(::x10::lang::String* s,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->print(::x10::lang::String::__plus(s, (__extension__ ({ static ::x10::lang::String* strLit__42976 = ::x10aux::makeStringLit(" = "); strLit__42976; }))));
    ...
    ::x10::lang::Rail< x10_int >* rail__37086 = d;
    x10_long i__37003min__37087 = ((x10_long)0ll);
    x10_long i__37003max__37088 = (x10_long)(::x10aux::nullCheck(rail__37086)->FMGL(size));
    {
        x10_long i__37089;
        for (i__37089 = i__37003min__37087; ((i__37089) < (i__37003max__37088));
             i__37089 = ((i__37089) + (((x10_long)1ll)))) {
            x10_long p__37090 = i__37089;
            ...
            ::x10::io::Console::FMGL(OUT__get)()->print(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__42977 = ::x10aux::makeStringLit(" "); strLit__42977; })), ::x10aux::nullCheck(d)->x10::lang::Rail< x10_int >::__apply(
                                                                                                                                                                                                      p__37090)));
        }
    }
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__42979 = ::x10aux::makeStringLit(""); strLit__42979; }))));
}
...
::x10::lang::Rail< x10_int >* cpls::problem::ProblemGenericModel::initialize(
  x10_long inSeed) {
    ...
    if (!(::x10aux::nullCheck(this->FMGL(inPathVectorSol))->x10::lang::String::equalsIgnoreCase(
            (__extension__ ({ static ::x10::lang::String* strLit__42980 = ::x10aux::makeStringLit("."); strLit__42980; })))))
    {
        ...
        ::x10::lang::String* buffer = (__extension__ ({ static ::x10::lang::String* strLit__42981 = ::x10aux::makeStringLit(""); strLit__42981; }));
        ...
        //#line 114 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/problem/ProblemGenericModel.x10"
        {
            for (i = ((x10_int)0); ((i) < (::x10aux::nullCheck(line)->x10::lang::String::length()));
                                             ...
                                             ((x10_char)'\n')))))
                {
                    ...
                    buffer = (__extension__ ({ static ::x10::lang::String* strLit__42982 = ::x10aux::makeStringLit(""); strLit__42982; }));
                } else {
        ...
        if (!(::x10aux::equals(buffer,(__extension__ ({ static ::x10::lang::String* strLit__42983 = ::x10aux::makeStringLit(""); strLit__42983; })))))
        {
        ...
        if (((j) < (this->FMGL(size)))) {
            ...
            ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
              reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__42984 = ::x10aux::makeStringLit("ModelAS ERROR: The input vector is shorter than the variables array. Valor j: "); strLit__42984; })), j)));
        }
        ...
        ::x10::lang::Rail< x10_int >* rail__37095 = variables;
        x10_long i__37020min__37096 = ((x10_long)0ll);
        x10_long i__37020max__37097 = (x10_long)(::x10aux::nullCheck(rail__37095)->FMGL(size));
        {
            x10_long i__37098;
            for (i__37098 = i__37020min__37096; ((i__37098) < (i__37020max__37097));
                 i__37098 = ((i__37098) + (((x10_long)1ll))))
            {
                x10_long mi__37099 = i__37098;
                ...
                x10_int value__37094 = ::x10aux::nullCheck(variables)->x10::lang::Rail< x10_int >::__apply(
                                         mi__37099);
                ...
                ::x10::lang::Rail< x10_int >* a__37091 = permutV;
                x10_long i__37092 = ((((x10_long)(value__37094))) - (((x10_long)1ll)));
                x10_int r__37093 = ((a__37091->x10::lang::Rail< x10_int >::__apply(
                                       i__37092)) + (((x10_int)1)));
                a__37091->x10::lang::Rail< x10_int >::__set(
                  i__37092, r__37093);
                ...
                if (((((x10_long)(permutV->x10::lang::Rail< x10_int >::__apply(
                                    ((((x10_long)(value__37094))) - (((x10_long)1ll))))))) > (((x10_long)1ll))))
                {
                    ...
                    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
                      reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__42988 = ::x10aux::makeStringLit("ERROR: Not valid permutation, value "); strLit__42988; })), value__37094), (__extension__ ({ static ::x10::lang::String* strLit__42989 = ::x10aux::makeStringLit(" is repeted "); strLit__42989; }))), mi__37099)));
                }
        ...
        ::cpls::util::Utils::show((__extension__ ({ static ::x10::lang::String* strLit__42990 = ::x10aux::makeStringLit("after ini"); strLit__42990; })),
                                  variables);
    } else {
        ...
        ::x10::lang::Rail< x10_int >* rail__37100 = variables;
        x10_long i__37037min__37101 = ((x10_long)0ll);
        x10_long i__37037max__37102 = (x10_long)(::x10aux::nullCheck(rail__37100)->FMGL(size));
        {
            x10_long i__37103;
            for (i__37103 = i__37037min__37101; ((i__37103) < (i__37037max__37102));
                 i__37103 = ((i__37103) + (((x10_long)1ll))))
            {
                x10_long k__37104 = i__37103;
                ...
                ::x10aux::nullCheck(variables)->x10::lang::Rail< x10_int >::__set(
                  k__37104, ((this->FMGL(baseValue)) + (((x10_int) (k__37104)))));
            }
        }
    ...
    ::x10::lang::Rail< x10_int >* t__37105 = variables;
    if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__37105)->FMGL(size)),
                                   ::x10aux::nullCheck(this)->FMGL(size)))))
    {
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__42993 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{self.size==this(:cpls.problem.ProblemGenericModel).size}"); strLit__42993; })))));
    }
    return t__37105;
...
void cpls::problem::ProblemGenericModel::clearProblemModel(
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__42994 = ::x10aux::makeStringLit("Error. clearProblemModel invoke in HeuristicSolver"); strLit__42994; }))));
}
...
void cpls::problem::ProblemGenericModel::displaySolution(
  x10_long sz, ::x10::lang::Rail< x10_int >* conf) {
    ...
    ::cpls::util::Utils::show((__extension__ ({ static ::x10::lang::String* strLit__42995 = ::x10aux::makeStringLit("Solution"); strLit__42995; })),
                              conf);
}
...
x10_boolean cpls::problem::ProblemGenericModel::verify(x10_long sz,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__42996 = ::x10aux::makeStringLit("Se ingresa al Verify de ProblemGenericModel"); strLit__42996; }))));
...
::x10::lang::Rail< x10_int >* cpls::problem::ProblemGenericModel::createNewSol(
    ...
    ::x10::lang::Rail< x10_int >* rail__37106 = variables;
    x10_long i__37054min__37107 = ((x10_long)0ll);
    x10_long i__37054max__37108 = (x10_long)(::x10aux::nullCheck(rail__37106)->FMGL(size));
    {
        x10_long i__37109;
        for (i__37109 = i__37054min__37107; ((i__37109) < (i__37054max__37108));
             i__37109 = ((i__37109) + (((x10_long)1ll))))
        {
            x10_long k__37110 = i__37109;
            ...
            ::x10aux::nullCheck(variables)->x10::lang::Rail< x10_int >::__set(
              k__37110, ((this->FMGL(baseValue)) + (((x10_int) (k__37110)))));
        }
    }
    ...
    ::x10::lang::Rail< x10_int >* t__37111 = variables;
    if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__37111)->FMGL(size)),
                                   ::x10aux::nullCheck(this)->FMGL(size)))))
    {
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__42999 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{self.size==this(:cpls.problem.ProblemGenericModel).size}"); strLit__42999; })))));
    }
    return t__37111;
...
x10_double cpls::problem::ProblemGenericModel::distance(x10_long sz,
    ...
    x10_int i__37071min__37112 = ((x10_int)0);
    x10_int i__37071max__37113 = ((((x10_int) (this->FMGL(size)))) - (((x10_int)1)));
    {
        x10_int i__37114;
        for (i__37114 = i__37071min__37112; ((i__37114) <= (i__37071max__37113));
             i__37114 = ((i__37114) + (((x10_int)1)))) {
            x10_int i__37115 = i__37114;
