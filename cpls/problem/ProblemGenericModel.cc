...
void cpls::problem::ProblemGenericModel::_constructor(x10_long sizeProblem) {
    ...
    this->FMGL(r) = (__extension__ ({
        ::x10::util::Random* alloc__892 =  (new (::x10aux::alloc_z< ::x10::util::Random>()) ::x10::util::Random());
        ...
        (alloc__892)->::x10::util::Random::_constructor(::x10::lang::RuntimeNatives::nanoTime());
        alloc__892;
    }))
    ;
}
...
x10_long cpls::problem::ProblemGenericModel::costOnVariable(x10_long i) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__3328 = ::x10aux::makeStringLit("Error bad costOnVariable"); strLit__3328; }))));
...
x10_long cpls::problem::ProblemGenericModel::costIfSwap(x10_long current_cost,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__3329 = ::x10aux::makeStringLit("Error costIfSwap"); strLit__3329; }))));
...
void cpls::problem::ProblemGenericModel::executedSwap(x10_long i1, x10_long i2) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__3330 = ::x10aux::makeStringLit("Error no executedSwap implementation"); strLit__3330; }))));
}
...
x10_long cpls::problem::ProblemGenericModel::costOfSolution(x10_boolean shouldBeRecorded) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__3333 = ::x10aux::makeStringLit("Error costOfSolution"); strLit__3333; }))));
...
void cpls::problem::ProblemGenericModel::show(::x10::lang::String* s,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->print(::x10::lang::String::__plus(s, (__extension__ ({ static ::x10::lang::String* strLit__3334 = ::x10aux::makeStringLit(" = "); strLit__3334; }))));
    ...
    ::x10::lang::Rail< x10_int >* rail__3309 = d;
    x10_long i__932max__3310 = (x10_long)(::x10aux::nullCheck(rail__3309)->FMGL(size));
    {
        x10_long i__3311;
        for (i__3311 = ((x10_long)0ll); ((i__3311) < (i__932max__3310));
             i__3311 = ((i__3311) + (((x10_long)1ll)))) {
            x10_long p__3312 = i__3311;
            ...
            ::x10::io::Console::FMGL(OUT__get)()->print(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__3335 = ::x10aux::makeStringLit(" "); strLit__3335; })), ::x10aux::nullCheck(d)->x10::lang::Rail< x10_int >::__apply(
                                                                                                                                                                                                    p__3312)));
        }
    }
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__3337 = ::x10aux::makeStringLit(""); strLit__3337; }))));
}
...
void cpls::problem::ProblemGenericModel::initialize() {
    ...
    if (!(::x10aux::nullCheck(this->FMGL(inPathVectorSol))->x10::lang::String::equalsIgnoreCase(
            (__extension__ ({ static ::x10::lang::String* strLit__3338 = ::x10aux::makeStringLit("."); strLit__3338; })))))
    {
        ...
        (fileIn)->::x10::io::FileReader::_constructor((__extension__ ({
                                                          ::x10::io::File* alloc__893 =
                                                            
                                                          (new (::x10aux::alloc_z< ::x10::io::File>()) ::x10::io::File());
                                                          (alloc__893)->::x10::io::File::_constructor(
        ...
        ::x10::lang::String* buffer = (__extension__ ({ static ::x10::lang::String* strLit__3339 = ::x10aux::makeStringLit(""); strLit__3339; }));
        ...
        //#line 93 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/problem/ProblemGenericModel.x10"
        {
            for (i = ((x10_int)0); ((i) < (::x10aux::nullCheck(line)->x10::lang::String::length()));
                                             ...
                                             ((x10_char)'\n')))))
                {
                    ...
                    buffer = (__extension__ ({ static ::x10::lang::String* strLit__3340 = ::x10aux::makeStringLit(""); strLit__3340; }));
                } else {
        ...
        if (!(::x10aux::equals(buffer,(__extension__ ({ static ::x10::lang::String* strLit__3341 = ::x10aux::makeStringLit(""); strLit__3341; })))))
        {
        ...
        if (((j) < (this->FMGL(size)))) {
            ...
            ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
              reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__3342 = ::x10aux::makeStringLit("ModelAS ERROR: The input vector is shorter than the variables array. Valor j: "); strLit__3342; })), j)));
        }
        ...
        ::x10::lang::Rail< x10_int >* rail__3317 = this->FMGL(variables);
        x10_long i__949max__3318 = (x10_long)(::x10aux::nullCheck(rail__3317)->FMGL(size));
        {
            x10_long i__3319;
            for (i__3319 = ((x10_long)0ll); ((i__3319) < (i__949max__3318));
                 i__3319 = ((i__3319) + (((x10_long)1ll))))
            {
                x10_long mi__3320 = i__3319;
                ...
                x10_int value__3316 = this->FMGL(variables)->x10::lang::Rail< x10_int >::__apply(
                                        mi__3320);
                ...
                ::x10::lang::Rail< x10_int >* a__3313 = permutV;
                x10_long i__3314 = ((((x10_long)(value__3316))) - (((x10_long)1ll)));
                x10_int r__3315 = ((a__3313->x10::lang::Rail< x10_int >::__apply(
                                      i__3314)) + (((x10_int)1)));
                a__3313->x10::lang::Rail< x10_int >::__set(
                  i__3314, r__3315);
                ...
                if (((((x10_long)(permutV->x10::lang::Rail< x10_int >::__apply(
                                    ((((x10_long)(value__3316))) - (((x10_long)1ll))))))) > (((x10_long)1ll))))
                {
                    ...
                    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
                      reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__3346 = ::x10aux::makeStringLit("ERROR: Not valid permutation, value "); strLit__3346; })), value__3316), (__extension__ ({ static ::x10::lang::String* strLit__3347 = ::x10aux::makeStringLit(" is repeted "); strLit__3347; }))), mi__3320)));
                }
        ...
        ::cpls::util::Utils::show((__extension__ ({ static ::x10::lang::String* strLit__3348 = ::x10aux::makeStringLit("after ini"); strLit__3348; })),
                                  this->FMGL(variables));
    } else {
        ...
        ::x10::lang::Rail< x10_int >* rail__3321 = this->FMGL(variables);
        x10_long i__966max__3322 = (x10_long)(::x10aux::nullCheck(rail__3321)->FMGL(size));
        {
            x10_long i__3323;
            for (i__3323 = ((x10_long)0ll); ((i__3323) < (i__966max__3322));
                 i__3323 = ((i__3323) + (((x10_long)1ll))))
            {
                x10_long k__3324 = i__3323;
                ...
                this->FMGL(variables)->x10::lang::Rail< x10_int >::__set(
                  k__3324, ((this->FMGL(baseValue)) + (((x10_int) (k__3324)))));
            }
        }
...
void cpls::problem::ProblemGenericModel::displaySolution(
  ::x10::lang::Rail< x10_int >* conf) {
    ...
    ::cpls::util::Utils::show((__extension__ ({ static ::x10::lang::String* strLit__3349 = ::x10aux::makeStringLit("Solution"); strLit__3349; })),
                              conf);
}
...
x10_boolean cpls::problem::ProblemGenericModel::verify(::x10::lang::Rail< x10_int >* conf) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__3350 = ::x10aux::makeStringLit("Se ingresa al Verify de ProblemGenericModel"); strLit__3350; }))));
...
x10_double cpls::problem::ProblemGenericModel::distance(::x10::lang::Rail< x10_int >* conf1,
    ...
    x10_int i__983max__3325 = ((((x10_int) (this->FMGL(size)))) - (((x10_int)1)));
    {
        x10_int i__3326;
        for (i__3326 = ((x10_int)0); ((i__3326) <= (i__983max__3325));
             i__3326 = ((i__3326) + (((x10_int)1)))) {
            x10_int i__3327 = i__3326;
