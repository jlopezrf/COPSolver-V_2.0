...
class cpls_problem_ProblemGenericModel__closure__2 : public ::x10::lang::Closure {
    ...
    const char* toNativeString() {
        return "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/problem/ProblemGenericModel.x10:204";
    }
...
void cpls::problem::ProblemGenericModel::_constructor(x10_long sizeProblem) {
    ...
    //#line 9 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/problem/ProblemGenericModel.x10"
    ::cpls::problem::ProblemGenericModel* this__3430 = this;
    ::x10aux::nullCheck(this__3430)->FMGL(baseValue) = ((x10_int)0);
    ::x10aux::nullCheck(this__3430)->FMGL(inSeed) = ((x10_long)0ll);
    ::x10aux::nullCheck(this__3430)->FMGL(r) = (::x10aux::class_cast_unchecked< ::x10::util::Random*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    ::x10aux::nullCheck(this__3430)->FMGL(inPathDataProblem) = (::x10aux::class_cast_unchecked< ::x10::lang::String*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    ::x10aux::nullCheck(this__3430)->FMGL(inPathVectorSol) = (::x10aux::class_cast_unchecked< ::x10::lang::String*>(reinterpret_cast< ::x10::lang::NullType*>(X10_NULL)));
    ...
    this->FMGL(r) = (__extension__ ({
        ::x10::util::Random* alloc__989 =  (new (::x10aux::alloc_z< ::x10::util::Random>()) ::x10::util::Random());
        ...
        (alloc__989)->::x10::util::Random::_constructor(::x10::lang::RuntimeNatives::nanoTime());
        alloc__989;
    }))
    ;
}
...
x10_long cpls::problem::ProblemGenericModel::costOnVariable(x10_long i) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__3456 = ::x10aux::makeStringLit("Error bad costOnVariable"); strLit__3456; }))));
...
x10_long cpls::problem::ProblemGenericModel::costIfSwap(x10_long current_cost,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__3457 = ::x10aux::makeStringLit("Error costIfSwap"); strLit__3457; }))));
...
void cpls::problem::ProblemGenericModel::executedSwap(x10_long sz, x10_long i1,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__3458 = ::x10aux::makeStringLit("Error no executedSwap implementation"); strLit__3458; }))));
}
...
x10_long cpls::problem::ProblemGenericModel::costOfSolution(x10_long sz,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__3460 = ::x10aux::makeStringLit("Error costOfSolution"); strLit__3460; }))));
...
void cpls::problem::ProblemGenericModel::show(::x10::lang::String* s,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->print(::x10::lang::String::__plus(s, (__extension__ ({ static ::x10::lang::String* strLit__3461 = ::x10aux::makeStringLit(" = "); strLit__3461; }))));
    ...
    ::x10::lang::Rail< x10_int >* rail__3431 = d;
    x10_long i__1029max__3432 = (x10_long)(::x10aux::nullCheck(rail__3431)->FMGL(size));
    {
        x10_long i__3433;
        for (i__3433 = ((x10_long)0ll); ((i__3433) < (i__1029max__3432));
             i__3433 = ((i__3433) + (((x10_long)1ll)))) {
            x10_long p__3434 = i__3433;
            ...
            ::x10::io::Console::FMGL(OUT__get)()->print(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__3462 = ::x10aux::makeStringLit(" "); strLit__3462; })), ::x10aux::nullCheck(d)->x10::lang::Rail< x10_int >::__apply(
                                                                                                                                                                                                    p__3434)));
        }
    }
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__3464 = ::x10aux::makeStringLit(""); strLit__3464; }))));
}
...
::x10::lang::Rail< x10_int >* cpls::problem::ProblemGenericModel::initialize(
  x10_long inSeed) {
    ...
    ::x10::util::Random* this__3447 = this->FMGL(r);
    ...
    ::x10aux::nullCheck(this__3447)->x10::util::Random::init(
      seed__3448);
    ...
    if (!(::x10aux::nullCheck(this->FMGL(inPathVectorSol))->x10::lang::String::equalsIgnoreCase(
            (__extension__ ({ static ::x10::lang::String* strLit__3465 = ::x10aux::makeStringLit("."); strLit__3465; })))))
    {
        ...
        (fileIn)->::x10::io::FileReader::_constructor((__extension__ ({
                                                          ::x10::io::File* alloc__990 =
                                                            
                                                          (new (::x10aux::alloc_z< ::x10::io::File>()) ::x10::io::File());
                                                          (alloc__990)->::x10::io::File::_constructor(
        ...
        ::x10::lang::String* buffer = (__extension__ ({ static ::x10::lang::String* strLit__3466 = ::x10aux::makeStringLit(""); strLit__3466; }));
        ...
        //#line 114 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/problem/ProblemGenericModel.x10"
        {
            for (i = ((x10_int)0); ((i) < (::x10aux::nullCheck(line)->x10::lang::String::length()));
                                             ...
                                             ((x10_char)'\n')))))
                {
                    ...
                    buffer = (__extension__ ({ static ::x10::lang::String* strLit__3467 = ::x10aux::makeStringLit(""); strLit__3467; }));
                } else {
        ...
        if (!(::x10aux::equals(buffer,(__extension__ ({ static ::x10::lang::String* strLit__3468 = ::x10aux::makeStringLit(""); strLit__3468; })))))
        {
        ...
        if (((j) < (this->FMGL(size)))) {
            ...
            ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
              reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__3469 = ::x10aux::makeStringLit("ModelAS ERROR: The input vector is shorter than the variables array. Valor j: "); strLit__3469; })), j)));
        }
        ...
        ::x10::lang::Rail< x10_int >* rail__3439 = variables;
        x10_long i__1046max__3440 = (x10_long)(::x10aux::nullCheck(rail__3439)->FMGL(size));
        {
            x10_long i__3441;
            for (i__3441 = ((x10_long)0ll); ((i__3441) < (i__1046max__3440));
                 i__3441 = ((i__3441) + (((x10_long)1ll))))
            {
                x10_long mi__3442 = i__3441;
                ...
                x10_int value__3438 = ::x10aux::nullCheck(variables)->x10::lang::Rail< x10_int >::__apply(
                                        mi__3442);
                ...
                ::x10::lang::Rail< x10_int >* a__3435 = permutV;
                x10_long i__3436 = ((((x10_long)(value__3438))) - (((x10_long)1ll)));
                x10_int r__3437 = ((a__3435->x10::lang::Rail< x10_int >::__apply(
                                      i__3436)) + (((x10_int)1)));
                a__3435->x10::lang::Rail< x10_int >::__set(
                  i__3436, r__3437);
                ...
                if (((((x10_long)(permutV->x10::lang::Rail< x10_int >::__apply(
                                    ((((x10_long)(value__3438))) - (((x10_long)1ll))))))) > (((x10_long)1ll))))
                {
                    ...
                    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
                      reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__3473 = ::x10aux::makeStringLit("ERROR: Not valid permutation, value "); strLit__3473; })), value__3438), (__extension__ ({ static ::x10::lang::String* strLit__3474 = ::x10aux::makeStringLit(" is repeted "); strLit__3474; }))), mi__3442)));
                }
        ...
        ::cpls::util::Utils::show((__extension__ ({ static ::x10::lang::String* strLit__3475 = ::x10aux::makeStringLit("after ini"); strLit__3475; })),
                                  variables);
    } else {
        ...
        ::x10::lang::Rail< x10_int >* rail__3443 = variables;
        x10_long i__1063max__3444 = (x10_long)(::x10aux::nullCheck(rail__3443)->FMGL(size));
        {
            x10_long i__3445;
            for (i__3445 = ((x10_long)0ll); ((i__3445) < (i__1063max__3444));
                 i__3445 = ((i__3445) + (((x10_long)1ll))))
            {
                x10_long k__3446 = i__3445;
                ...
                ::x10aux::nullCheck(variables)->x10::lang::Rail< x10_int >::__set(
                  k__3446, ((this->FMGL(baseValue)) + (((x10_int) (k__3446)))));
            }
        }
...
void cpls::problem::ProblemGenericModel::clearProblemModel(
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__3478 = ::x10aux::makeStringLit("Error. clearProblemModel invoke in HeuristicSolver"); strLit__3478; }))));
}
...
void cpls::problem::ProblemGenericModel::displaySolution(
  x10_long sz, ::x10::lang::Rail< x10_int >* conf) {
    ...
    ::cpls::util::Utils::show((__extension__ ({ static ::x10::lang::String* strLit__3479 = ::x10aux::makeStringLit("Solution"); strLit__3479; })),
                              conf);
}

//#line 182 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/problem/ProblemGenericModel.x10"
x10_boolean cpls::problem::ProblemGenericModel::verify(x10_long sz,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__3480 = ::x10aux::makeStringLit("Se ingresa al Verify de ProblemGenericModel"); strLit__3480; }))));
    
    //#line 184 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/problem/ProblemGenericModel.x10"
    return true;
...
x10_long cpls::problem::ProblemGenericModel::nextJ(x10_long i,
    ...
    //#line 193 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/problem/ProblemGenericModel.x10"
    x10_long newj = j;
    
    //#line 194 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/problem/ProblemGenericModel.x10"
...
::x10::lang::Rail< x10_int >* cpls::problem::ProblemGenericModel::createNewSol(
    ...
    ::x10::lang::Rail< x10_int >* rail__3449 = variables;
    x10_long i__1080max__3450 = (x10_long)(::x10aux::nullCheck(rail__3449)->FMGL(size));
    {
        x10_long i__3451;
        for (i__3451 = ((x10_long)0ll); ((i__3451) < (i__1080max__3450));
             i__3451 = ((i__3451) + (((x10_long)1ll)))) {
            x10_long k__3452 = i__3451;
            ...
            ::x10aux::nullCheck(variables)->x10::lang::Rail< x10_int >::__set(
              k__3452, ((this->FMGL(baseValue)) + (((x10_int) (k__3452)))));
        }
    }
    ...
    //#line 208 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/problem/ProblemGenericModel.x10"
    {
             ...
             ((i) > (((x10_long)0ll))); i = ((i) - (((x10_long)1ll))))
        {
            ...
            //#line 211 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/problem/ProblemGenericModel.x10"
            ::x10aux::nullCheck(variables)->x10::lang::Rail< x10_int >::__set(
              i, ::x10aux::nullCheck(variables)->x10::lang::Rail< x10_int >::__apply(
                   j));
            
            //#line 212 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/problem/ProblemGenericModel.x10"
            ::x10aux::nullCheck(variables)->x10::lang::Rail< x10_int >::__set(
              j, x);
        }
    }
    
    //#line 214 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/problem/ProblemGenericModel.x10"
    return variables;
...
x10_double cpls::problem::ProblemGenericModel::distance(x10_long sz,
    ...
    //#line 220 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/problem/ProblemGenericModel.x10"
    ...
    x10_int i__1097max__3453 = ((((x10_int) (this->FMGL(size)))) - (((x10_int)1)));
    {
        x10_int i__3454;
        for (i__3454 = ((x10_int)0); ((i__3454) <= (i__1097max__3453));
             i__3454 = ((i__3454) + (((x10_int)1)))) {
            x10_int i__3455 = i__3454;
    ...
    //#line 225 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/problem/ProblemGenericModel.x10"
    x10_double dis = ((((x10_double) (count))) / (((x10_double) (this->FMGL(size)))));
    
    //#line 227 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/cpls/problem/ProblemGenericModel.x10"
    return dis;
