...
x10_long cpls::problem::ProblemGenericModel::costOnVariable(x10_long i) {
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__41898 = ::x10aux::makeStringLit("Error bad costOnVariable"); strLit__41898; }))));
...
x10_long cpls::problem::ProblemGenericModel::costIfSwap(x10_long current_cost,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__41899 = ::x10aux::makeStringLit("Error costIfSwap"); strLit__41899; }))));
...
void cpls::problem::ProblemGenericModel::executedSwap(x10_long sz, x10_long i1,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__41900 = ::x10aux::makeStringLit("Error no executedSwap implementation"); strLit__41900; }))));
}
...
x10_long cpls::problem::ProblemGenericModel::costOfSolution(x10_long sz, x10_boolean shouldBeRecorded,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__41901 = ::x10aux::makeStringLit("Error costOfSolution"); strLit__41901; }))));
...
x10_long cpls::problem::ProblemGenericModel::costOfSolution(x10_long sz,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__41902 = ::x10aux::makeStringLit("Error costOfSolution"); strLit__41902; }))));
...
void cpls::problem::ProblemGenericModel::show(::x10::lang::String* s,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->print(::x10::lang::String::__plus(s, (__extension__ ({ static ::x10::lang::String* strLit__41903 = ::x10aux::makeStringLit(" = "); strLit__41903; }))));
    ...
    ::x10::lang::Rail< x10_int >* rail__36098 = d;
    x10_long i__36015min__36099 = ((x10_long)0ll);
    x10_long i__36015max__36100 = (x10_long)(::x10aux::nullCheck(rail__36098)->FMGL(size));
    {
        x10_long i__36101;
        for (i__36101 = i__36015min__36099; ((i__36101) < (i__36015max__36100));
             i__36101 = ((i__36101) + (((x10_long)1ll)))) {
            x10_long p__36102 = i__36101;
            ...
            ::x10::io::Console::FMGL(OUT__get)()->print(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__41904 = ::x10aux::makeStringLit(" "); strLit__41904; })), ::x10aux::nullCheck(d)->x10::lang::Rail< x10_int >::__apply(
                                                                                                                                                                                                      p__36102)));
        }
    }
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__41906 = ::x10aux::makeStringLit(""); strLit__41906; }))));
}
...
::x10::lang::Rail< x10_int >* cpls::problem::ProblemGenericModel::initialize(
  x10_long inSeed) {
    ...
    if (!(::x10aux::nullCheck(this->FMGL(inPathVectorSol))->x10::lang::String::equalsIgnoreCase(
            (__extension__ ({ static ::x10::lang::String* strLit__41907 = ::x10aux::makeStringLit("."); strLit__41907; })))))
    {
        ...
        ::x10::lang::String* buffer = (__extension__ ({ static ::x10::lang::String* strLit__41908 = ::x10aux::makeStringLit(""); strLit__41908; }));
        ...
        //#line 114 "/home/jason/Documents/Maestria/Implementacion/X10/Repositorio/COPSolver-V_2.0/src/cpls/problem/ProblemGenericModel.x10"
        {
            for (i = ((x10_int)0); ((i) < (::x10aux::nullCheck(line)->x10::lang::String::length()));
                                             ...
                                             ((x10_char)'\n')))))
                {
                    ...
                    buffer = (__extension__ ({ static ::x10::lang::String* strLit__41909 = ::x10aux::makeStringLit(""); strLit__41909; }));
                } else {
        ...
        if (!(::x10aux::equals(buffer,(__extension__ ({ static ::x10::lang::String* strLit__41910 = ::x10aux::makeStringLit(""); strLit__41910; })))))
        {
        ...
        if (((j) < (this->FMGL(size)))) {
            ...
            ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
              reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__41911 = ::x10aux::makeStringLit("ModelAS ERROR: The input vector is shorter than the variables array. Valor j: "); strLit__41911; })), j)));
        }
        ...
        ::x10::lang::Rail< x10_int >* rail__36107 = variables;
        x10_long i__36032min__36108 = ((x10_long)0ll);
        x10_long i__36032max__36109 = (x10_long)(::x10aux::nullCheck(rail__36107)->FMGL(size));
        {
            x10_long i__36110;
            for (i__36110 = i__36032min__36108; ((i__36110) < (i__36032max__36109));
                 i__36110 = ((i__36110) + (((x10_long)1ll))))
            {
                x10_long mi__36111 = i__36110;
                ...
                x10_int value__36106 = ::x10aux::nullCheck(variables)->x10::lang::Rail< x10_int >::__apply(
                                         mi__36111);
                ...
                ::x10::lang::Rail< x10_int >* a__36103 = permutV;
                x10_long i__36104 = ((((x10_long)(value__36106))) - (((x10_long)1ll)));
                x10_int r__36105 = ((a__36103->x10::lang::Rail< x10_int >::__apply(
                                       i__36104)) + (((x10_int)1)));
                a__36103->x10::lang::Rail< x10_int >::__set(
                  i__36104, r__36105);
                ...
                if (((((x10_long)(permutV->x10::lang::Rail< x10_int >::__apply(
                                    ((((x10_long)(value__36106))) - (((x10_long)1ll))))))) > (((x10_long)1ll))))
                {
                    ...
                    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
                      reinterpret_cast< ::x10::lang::Any*>(::x10::lang::String::__plus(::x10::lang::String::__plus(::x10::lang::String::__plus((__extension__ ({ static ::x10::lang::String* strLit__41915 = ::x10aux::makeStringLit("ERROR: Not valid permutation, value "); strLit__41915; })), value__36106), (__extension__ ({ static ::x10::lang::String* strLit__41916 = ::x10aux::makeStringLit(" is repeted "); strLit__41916; }))), mi__36111)));
                }
        ...
        ::cpls::util::Utils::show((__extension__ ({ static ::x10::lang::String* strLit__41917 = ::x10aux::makeStringLit("after ini"); strLit__41917; })),
                                  variables);
    } else {
        ...
        ::x10::lang::Rail< x10_int >* rail__36112 = variables;
        x10_long i__36049min__36113 = ((x10_long)0ll);
        x10_long i__36049max__36114 = (x10_long)(::x10aux::nullCheck(rail__36112)->FMGL(size));
        {
            x10_long i__36115;
            for (i__36115 = i__36049min__36113; ((i__36115) < (i__36049max__36114));
                 i__36115 = ((i__36115) + (((x10_long)1ll))))
            {
                x10_long k__36116 = i__36115;
                ...
                ::x10aux::nullCheck(variables)->x10::lang::Rail< x10_int >::__set(
                  k__36116, ((this->FMGL(baseValue)) + (((x10_int) (k__36116)))));
            }
        }
    ...
    ::x10::lang::Rail< x10_int >* t__36117 = variables;
    if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__36117)->FMGL(size)),
                                   ::x10aux::nullCheck(this)->FMGL(size)))))
    {
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__41920 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{self.size==this(:cpls.problem.ProblemGenericModel).size}"); strLit__41920; })))));
    }
    return t__36117;
...
void cpls::problem::ProblemGenericModel::clearProblemModel(
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__41921 = ::x10aux::makeStringLit("Error. clearProblemModel invoke in HeuristicSolver"); strLit__41921; }))));
}
...
void cpls::problem::ProblemGenericModel::displaySolution(
  x10_long sz, ::x10::lang::Rail< x10_int >* conf) {
    ...
    ::cpls::util::Utils::show((__extension__ ({ static ::x10::lang::String* strLit__41922 = ::x10aux::makeStringLit("Solution"); strLit__41922; })),
                              conf);
}
...
x10_boolean cpls::problem::ProblemGenericModel::verify(x10_long sz,
    ...
    ::x10::io::Console::FMGL(OUT__get)()->x10::io::Printer::println(
      reinterpret_cast< ::x10::lang::Any*>((__extension__ ({ static ::x10::lang::String* strLit__41923 = ::x10aux::makeStringLit("Se ingresa al Verify de ProblemGenericModel"); strLit__41923; }))));
...
::x10::lang::Rail< x10_int >* cpls::problem::ProblemGenericModel::createNewSol(
    ...
    ::x10::lang::Rail< x10_int >* rail__36118 = variables;
    x10_long i__36066min__36119 = ((x10_long)0ll);
    x10_long i__36066max__36120 = (x10_long)(::x10aux::nullCheck(rail__36118)->FMGL(size));
    {
        x10_long i__36121;
        for (i__36121 = i__36066min__36119; ((i__36121) < (i__36066max__36120));
             i__36121 = ((i__36121) + (((x10_long)1ll))))
        {
            x10_long k__36122 = i__36121;
            ...
            ::x10aux::nullCheck(variables)->x10::lang::Rail< x10_int >::__set(
              k__36122, ((this->FMGL(baseValue)) + (((x10_int) (k__36122)))));
        }
    }
    ...
    ::x10::lang::Rail< x10_int >* t__36123 = variables;
    if (!((::x10aux::struct_equals((x10_long)(::x10aux::nullCheck(t__36123)->FMGL(size)),
                                   ::x10aux::nullCheck(this)->FMGL(size)))))
    {
        ::x10aux::throwException(::x10aux::nullCheck(::x10::lang::FailedDynamicCheckException::_make((__extension__ ({ static ::x10::lang::String* strLit__41926 = ::x10aux::makeStringLit("x10.lang.Rail[x10.lang.Int]{self.size==this(:cpls.problem.ProblemGenericModel).size}"); strLit__41926; })))));
    }
    return t__36123;
...
x10_double cpls::problem::ProblemGenericModel::distance(x10_long sz,
    ...
    x10_int i__36083min__36124 = ((x10_int)0);
    x10_int i__36083max__36125 = ((((x10_int) (this->FMGL(size)))) - (((x10_int)1)));
    {
        x10_int i__36126;
        for (i__36126 = i__36083min__36124; ((i__36126) <= (i__36083max__36125));
             i__36126 = ((i__36126) + (((x10_int)1)))) {
            x10_int i__36127 = i__36126;
